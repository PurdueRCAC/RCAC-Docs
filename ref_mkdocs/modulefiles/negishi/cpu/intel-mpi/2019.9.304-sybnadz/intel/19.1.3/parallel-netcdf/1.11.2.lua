-- -*- lua -*---
-- parallel-netcdf@1.11.2%intel@19.1.3~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky8-zen3/izx4ukm
--
...
local modroot="/apps/spack/negishi/apps/parallel-netcdf/1.11.2-intel-19.1.3-izx4ukm"
