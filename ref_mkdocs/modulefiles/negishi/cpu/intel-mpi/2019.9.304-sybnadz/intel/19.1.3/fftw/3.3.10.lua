-- -*- lua -*---
-- fftw@3.3.10%intel@19.1.3+mpi+openmp~pfft_patches build_system=autotools precision=double,float arch=linux-rocky8-zen3/kwmyja4
--
...
local modroot="/apps/spack/negishi/apps/fftw/3.3.10-intel-19.1.3-kwmyja4"
