...
This version includes the codes for finding saddle points and evaluating transition state theory (TST) rate constants with VASP. More details can be found at https://theory.cm.utexas.edu/vtsttools/ ]])
...
local modroot="/apps/external/apps/vasp/6.4.1_vtst"
