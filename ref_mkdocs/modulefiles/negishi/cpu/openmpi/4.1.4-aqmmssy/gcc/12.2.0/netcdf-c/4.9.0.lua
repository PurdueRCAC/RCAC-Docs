-- -*- lua -*---
-- netcdf-c@4.9.0%gcc@12.2.0~dap~fsync+hdf4~jna+mpi+optimize~parallel-netcdf+pic+shared+zstd build_system=autotools arch=linux-rocky8-zen3/jytdgrw
--
...
whatis([[Configure options : --enable-v2 --enable-utilities --enable-static --enable-largefile --enable-netcdf-4 --disable-fsync --enable-dynamic-loading --enable-shared --disable-dap ac_cv_lib_curl_curl_easy_setopt=no --enable-parallel4 --disable-jna --disable-pnetcdf CC=/apps/spack/negishi/apps/openmpi/4.1.4-gcc-12.2.0-aqmmssy/bin/mpicc --enable-hdf4 --with-plugin-dir=/apps/spack/negishi/apps/netcdf-c/4.9.0-gcc-12.2.0-jytdgrw/plugins CFLAGS=-O2 -fPIC CPPFLAGS=-I/apps/spack/negishi/apps/hdf5/1.13.2-gcc-12.2.0-zzksp3u/include -I/apps/spack/negishi/apps/hdf/4.2.15-gcc-12.2.0-xu7bxhi/include -I/apps/spack/negishi/apps/zstd/1.5.2-gcc-12.2.0-2xwr3wc/include LDFLAGS=-L/apps/spack/negishi/apps/hdf5/1.13.2-gcc-12.2.0-zzksp3u/lib -L/apps/spack/negishi/apps/hdf/4.2.15-gcc-12.2.0-xu7bxhi/lib -L/apps/spack/negishi/apps/zstd/1.5.2-gcc-12.2.0-2xwr3wc/lib LIBS=-ljpeg -lsz -ltirpc]])
...
local modroot="/apps/spack/negishi/apps/netcdf-c/4.9.0-gcc-12.2.0-jytdgrw"
