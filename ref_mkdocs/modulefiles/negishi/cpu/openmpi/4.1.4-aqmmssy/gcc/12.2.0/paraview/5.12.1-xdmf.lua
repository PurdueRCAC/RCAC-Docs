-- -*- lua -*---
-- paraview@5.12.1-xdmf%gcc@12.2.0~advanced_debug~cuda~examples+hdf5~ipo+kits+mpi+opengl2~osmesa+plugins~python+python3+qt+shared+xdmf build_system=cmake build_type=RelWithDebInfo patches=02253c7,405d451 arch=linux-rocky8-zen3/hicrlyq
--
...
local modroot="/apps/spack/negishi/apps/paraview/5.12.1-xdmf-gcc-12.2.0-hicrlyq"
...
setenv("PROJ_LIB", "/apps/spack/negishi/apps/proj/8.1.0-gcc-12.2.0-e3cvsxh/share/proj")
