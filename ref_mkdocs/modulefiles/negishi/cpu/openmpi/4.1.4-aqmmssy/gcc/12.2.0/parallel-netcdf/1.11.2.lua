-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@12.2.0~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky8-zen3/opftx37
--
...
local modroot="/apps/spack/negishi/apps/parallel-netcdf/1.11.2-gcc-12.2.0-opftx37"
