-- -*- lua -*---
-- netcdf-fortran@4.6.0%gcc@12.2.0~doc+pic+shared build_system=autotools arch=linux-rocky8-zen3/23p6jxt
--
...
local modroot="/apps/spack/negishi/apps/netcdf-fortran/4.6.0-gcc-12.2.0-23p6jxt"
