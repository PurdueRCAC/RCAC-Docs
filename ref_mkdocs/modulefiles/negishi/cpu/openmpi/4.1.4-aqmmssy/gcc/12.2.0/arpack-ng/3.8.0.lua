-- -*- lua -*---
-- arpack-ng@3.8.0%gcc@12.2.0~ipo+mpi+shared build_system=cmake build_type=RelWithDebInfo arch=linux-rocky8-zen3/vy5sok7
--
...
local modroot="/apps/spack/negishi/apps/arpack-ng/3.8.0-gcc-12.2.0-vy5sok7"
