-- -*- lua -*---
-- vtk@9.0.0%gcc@8.5.0+ffmpeg+ipo+mpi+opengl2~osmesa+python+qt+xdmf build_system=cmake build_type=RelWithDebInfo patches=0546696,87656ca,8a673a7 arch=linux-rocky8-zen/ogxcxt6
--
...
local modroot="/apps/spack/negishi/apps/vtk/9.0.0-gcc-8.5.0-ogxcxt6"
...
prepend_path("PYTHONPATH", "/apps/spack/negishi/apps/py-mpi4py/3.1.4-gcc-8.5.0-7k3nx2h/lib/python3.9/site-packages", ":")
