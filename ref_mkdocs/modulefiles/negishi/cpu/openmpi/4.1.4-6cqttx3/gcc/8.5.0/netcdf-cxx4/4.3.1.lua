-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@8.5.0~doc+pic+shared build_system=autotools arch=linux-rocky8-zen/l6kgozi
--
...
local modroot="/apps/spack/negishi/apps/netcdf-cxx4/4.3.1-gcc-8.5.0-l6kgozi"
