-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.5.0~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky8-zen/5abjbio
--
...
local modroot="/apps/spack/negishi/apps/parallel-netcdf/1.11.2-gcc-8.5.0-5abjbio"
