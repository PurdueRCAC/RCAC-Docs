-- -*- lua -*---
-- fftw@3.3.10%gcc@8.5.0+mpi+openmp~pfft_patches build_system=autotools precision=double,float arch=linux-rocky8-zen/u4ohwkz
--
...
local modroot="/apps/spack/negishi/apps/fftw/3.3.10-gcc-8.5.0-u4ohwkz"
