-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@11.2.0~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky8-zen3/xh7hntv
--
...
local modroot="/apps/spack/negishi/apps/parallel-netcdf/1.11.2-gcc-11.2.0-xh7hntv"
