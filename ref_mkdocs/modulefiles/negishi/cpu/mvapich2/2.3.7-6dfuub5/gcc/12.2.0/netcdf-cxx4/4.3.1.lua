-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@12.2.0~doc+pic+shared build_system=autotools arch=linux-rocky8-zen3/jurgozx
--
...
local modroot="/apps/spack/negishi/apps/netcdf-cxx4/4.3.1-gcc-12.2.0-jurgozx"
