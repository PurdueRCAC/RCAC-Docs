-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.5.0~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky8-zen/qjm2lrj
--
...
local modroot="/apps/spack/negishi/apps/parallel-netcdf/1.11.2-gcc-8.5.0-qjm2lrj"
