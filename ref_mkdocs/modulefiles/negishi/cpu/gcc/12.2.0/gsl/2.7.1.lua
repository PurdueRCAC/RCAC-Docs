-- -*- lua -*---
-- gsl@2.7.1%gcc@12.2.0~external-cblas build_system=autotools arch=linux-rocky8-zen3/oxu7x5x
--
...
local modroot="/apps/spack/negishi/apps/gsl/2.7.1-gcc-12.2.0-oxu7x5x"
