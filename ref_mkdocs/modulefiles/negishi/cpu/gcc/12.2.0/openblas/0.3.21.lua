-- -*- lua -*---
-- openblas@0.3.21%gcc@12.2.0~bignuma~consistent_fpcsr+fortran~ilp64+locking+pic+shared build_system=makefile patches=d3d9b15 symbol_suffix=none threads=openmp arch=linux-rocky8-zen3/lzvicim
--
...
local modroot="/apps/spack/negishi/apps/openblas/0.3.21-gcc-12.2.0-lzvicim"
