-- -*- lua -*---
-- libiconv@1.16%gcc@12.2.0 build_system=autotools libs=shared,static arch=linux-rocky8-zen3/grtsqit
--
...
local modroot="/apps/spack/negishi/apps/libiconv/1.16-gcc-12.2.0-grtsqit"
