-- -*- lua -*---
-- zlib@1.2.13%gcc@12.2.0+optimize+pic+shared build_system=makefile arch=linux-rocky8-zen3/lcttzi4
--
...
local modroot="/apps/spack/negishi/apps/zlib/1.2.13-gcc-12.2.0-lcttzi4"
