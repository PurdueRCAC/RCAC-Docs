-- -*- lua -*---
-- blis@0.8.1%gcc@12.2.0+blas+cblas build_system=makefile libs=shared,static threads=openmp arch=linux-rocky8-zen3/emfih3g
--
...
local modroot="/apps/spack/negishi/apps/blis/0.8.1-gcc-12.2.0-emfih3g"
