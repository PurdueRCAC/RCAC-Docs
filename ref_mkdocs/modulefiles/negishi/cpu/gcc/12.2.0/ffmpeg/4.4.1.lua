-- -*- lua -*---
-- ffmpeg@4.4.1%gcc@12.2.0+X+avresample+bzlib+drawtext+gpl+libaom+libmp3lame+libopenjpeg+libopus+libsnappy+libspeex~libssh+libvorbis~libvpx~libwebp~libx264~libzmq~lzma~nonfree~openssl~sdl2+shared+version3 build_system=autotools arch=linux-rocky8-zen3/nqay4sf
--
...
local modroot="/apps/spack/negishi/apps/ffmpeg/4.4.1-gcc-12.2.0-nqay4sf"
