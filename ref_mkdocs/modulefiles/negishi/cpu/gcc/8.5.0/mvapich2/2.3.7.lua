-- -*- lua -*---
-- mvapich2@2.3.7%gcc@8.5.0~alloca~cuda~debug+regcache+wrapperrpath build_system=autotools ch3_rank_bits=32 fabrics=mrail file_systems=auto process_managers=auto threads=multiple arch=linux-rocky8-zen/ja34p5x
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu/mvapich2/2.3.7-ja34p5x/gcc/8.5.0")
...
setenv("LMOD_MPI_VERSION", "2.3.7-ja34p5x")

depends_on("zlib/1.2.13")

local modroot="/apps/spack/negishi/apps/mvapich2/2.3.7-gcc-8.5.0-ja34p5x"
