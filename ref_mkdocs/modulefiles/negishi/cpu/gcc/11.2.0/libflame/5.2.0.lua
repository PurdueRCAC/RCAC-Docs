-- -*- lua -*---
-- libflame@5.2.0%gcc@11.2.0~debug+lapack2flame+shared+static build_system=autotools patches=bf75a5b,c5cae9e threads=none arch=linux-rocky8-zen3/vtnghmw
--
...
whatis([[Configure options : LIBS=-L/apps/spack/negishi/apps/openblas/0.3.21-gcc-11.2.0-3lizinx/lib -lopenblas --enable-lapack2flame --enable-static-build --enable-dynamic-build --disable-debug --enable-multithreading=no --disable-supermatrix --enable-max-arg-list-hack]])
...
local modroot="/apps/spack/negishi/apps/libflame/5.2.0-gcc-11.2.0-vtnghmw"
