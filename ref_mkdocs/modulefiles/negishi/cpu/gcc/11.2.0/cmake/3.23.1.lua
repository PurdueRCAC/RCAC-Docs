-- -*- lua -*---
-- cmake@3.23.1%gcc@11.2.0~doc+ncurses+ownlibs~qt build_system=generic build_type=Release arch=linux-rocky8-zen3/zvczhgv
--
...
local modroot="/apps/spack/negishi/apps/cmake/3.23.1-gcc-11.2.0-zvczhgv"
