-- -*- lua -*---
-- hdf5@1.13.2%gcc@11.2.0+cxx+fortran+hl~ipo~java~mpi+shared+szip+threadsafe+tools api=default build_system=cmake build_type=RelWithDebInfo arch=linux-rocky8-zen3/3scqsnu
--
...
local modroot="/apps/spack/negishi/apps/hdf5/1.13.2-gcc-11.2.0-3scqsnu"
