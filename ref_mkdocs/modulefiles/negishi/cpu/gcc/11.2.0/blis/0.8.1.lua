-- -*- lua -*---
-- blis@0.8.1%gcc@11.2.0+blas+cblas build_system=makefile libs=shared,static threads=openmp arch=linux-rocky8-zen3/dk5iu4k
--
...
local modroot="/apps/spack/negishi/apps/blis/0.8.1-gcc-11.2.0-dk5iu4k"
