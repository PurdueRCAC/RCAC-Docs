-- -*- lua -*---
-- tk@8.6.11%gcc@11.2.0+xft+xss build_system=autotools arch=linux-rocky8-zen3/cubaj4m
--
...
whatis([[Configure options : --with-tcl=/apps/spack/negishi/apps/tcl/8.6.11-gcc-11.2.0-nlbhy3y/lib --x-includes=/apps/spack/negishi/apps/libx11/1.7.0-gcc-11.2.0-aokwaou/include --x-libraries=/apps/spack/negishi/apps/libx11/1.7.0-gcc-11.2.0-aokwaou/lib --enable-xft --enable-xss]])
...
local modroot="/apps/spack/negishi/apps/tk/8.6.11-gcc-11.2.0-cubaj4m"
