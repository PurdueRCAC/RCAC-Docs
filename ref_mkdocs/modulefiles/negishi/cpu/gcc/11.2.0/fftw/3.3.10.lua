-- -*- lua -*---
-- fftw@3.3.10%gcc@11.2.0~mpi+openmp~pfft_patches build_system=autotools precision=double,float arch=linux-rocky8-zen3/mjoddy6
--
...
local modroot="/apps/spack/negishi/apps/fftw/3.3.10-gcc-11.2.0-mjoddy6"
