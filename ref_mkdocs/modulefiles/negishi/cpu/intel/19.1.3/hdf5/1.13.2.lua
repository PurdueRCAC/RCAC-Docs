-- -*- lua -*---
-- hdf5@1.13.2%intel@19.1.3+cxx+fortran+hl~ipo~java~mpi+shared+szip+threadsafe+tools api=default build_system=cmake build_type=RelWithDebInfo arch=linux-rocky8-zen3/4wqyhrj
--
...
local modroot="/apps/spack/negishi/apps/hdf5/1.13.2-intel-19.1.3-4wqyhrj"
