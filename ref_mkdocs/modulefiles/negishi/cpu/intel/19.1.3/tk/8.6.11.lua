-- -*- lua -*---
-- tk@8.6.11%intel@19.1.3+xft+xss build_system=autotools arch=linux-rocky8-zen3/cewsegu
--
...
whatis([[Configure options : --with-tcl=/apps/spack/negishi/apps/tcl/8.6.11-intel-19.1.3-nevi6se/lib --x-includes=/apps/spack/negishi/apps/libx11/1.7.0-intel-19.1.3-xjhxwrk/include --x-libraries=/apps/spack/negishi/apps/libx11/1.7.0-intel-19.1.3-xjhxwrk/lib --enable-xft --enable-xss]])
...
local modroot="/apps/spack/negishi/apps/tk/8.6.11-intel-19.1.3-cewsegu"
