-- -*- lua -*---
-- openblas@0.3.21%intel@19.1.3~bignuma~consistent_fpcsr+fortran~ilp64+locking+pic+shared build_system=makefile patches=d3d9b15 symbol_suffix=none threads=openmp arch=linux-rocky8-zen3/wxufdrp
--
...
local modroot="/apps/spack/negishi/apps/openblas/0.3.21-intel-19.1.3-wxufdrp"
