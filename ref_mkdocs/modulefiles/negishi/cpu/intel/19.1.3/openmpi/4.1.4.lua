-- -*- lua -*---
-- openmpi@4.1.4%intel@19.1.3~atomics~cuda+cxx+cxx_exceptions~gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~romio~rsh~singularity+static+vt+wrapper-rpath build_system=autotools fabrics=auto schedulers=slurm arch=linux-rocky8-zen3/a65ph3k
--

whatis([[Name : openmpi]])
whatis([[Version : 4.1.4]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --enable-mca-no-build=plm-rsh --enable-mpi1-compatibility --without-cray-xpmem --without-lsf --without-alps --without-tm --with-slurm --without-sge --without-loadleveler --disable-memchecker --with-libevent=/apps/spack/negishi/apps/libevent/2.1.12-intel-19.1.3-xstlpml --with-pmix=/apps/spack/negishi/apps/pmix/4.1.2-intel-19.1.3-cxq7yhl --with-zlib=/apps/spack/negishi/apps/zlib/1.2.13-intel-19.1.3-lnlnf4w --with-hwloc=/apps/spack/negishi/apps/hwloc/2.8.0-intel-19.1.3-xulx3v6 --disable-java --disable-mpi-java --disable-io-romio --with-gpfs=no --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions --with-wrapper-ldflags=-Wl,-rpath,/apps/external/apps/intel/cluster.2020.4/compilers_and_libraries_2020.4.304/linux/compiler/lib/intel64_lin]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu/openmpi/4.1.4-a65ph3k/intel/19.1.3")
...
setenv("LMOD_MPI_VERSION", "4.1.4-a65ph3k")

depends_on("numactl/2.0.14")
depends_on("zlib/1.2.13")

local modroot="/apps/spack/negishi/apps/openmpi/4.1.4-intel-19.1.3-a65ph3k"
