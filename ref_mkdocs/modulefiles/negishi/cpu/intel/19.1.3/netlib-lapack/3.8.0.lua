-- -*- lua -*---
-- netlib-lapack@3.8.0%intel@19.1.3~external-blas~ipo+lapacke+shared~xblas build_system=cmake build_type=RelWithDebInfo patches=5c79286,ad3d41f arch=linux-rocky8-zen3/njdsgyj
--
...
local modroot="/apps/spack/negishi/apps/netlib-lapack/3.8.0-intel-19.1.3-njdsgyj"
