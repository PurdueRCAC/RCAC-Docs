-- -*- lua -*---
-- mvapich2@2.3.7%intel@19.1.3~alloca~cuda~debug+regcache+wrapperrpath build_system=autotools ch3_rank_bits=32 fabrics=mrail file_systems=auto process_managers=auto threads=multiple arch=linux-rocky8-zen3/tpq7dsy
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu/mvapich2/2.3.7-tpq7dsy/intel/19.1.3")
...
setenv("LMOD_MPI_VERSION", "2.3.7-tpq7dsy")

depends_on("zlib/1.2.13")

local modroot="/apps/spack/negishi/apps/mvapich2/2.3.7-intel-19.1.3-tpq7dsy"
