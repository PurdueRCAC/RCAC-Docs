-- -*- lua -*---
-- zlib@1.2.13%intel@19.1.3+optimize+pic+shared build_system=makefile arch=linux-rocky8-zen3/lnlnf4w
--
...
local modroot="/apps/spack/negishi/apps/zlib/1.2.13-intel-19.1.3-lnlnf4w"
