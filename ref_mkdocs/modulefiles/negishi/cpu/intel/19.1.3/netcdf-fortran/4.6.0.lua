-- -*- lua -*---
-- netcdf-fortran@4.6.0%intel@19.1.3~doc+pic+shared build_system=autotools arch=linux-rocky8-zen3/m2bmqdi
--
...
local modroot="/apps/spack/negishi/apps/netcdf-fortran/4.6.0-intel-19.1.3-m2bmqdi"
