-- -*- lua -*---
-- libxml2@2.10.1%intel@19.1.3~python build_system=autotools arch=linux-rocky8-zen3/ifzh3dc
--
...
whatis([[Configure options : --with-lzma=/apps/spack/negishi/apps/xz/5.2.7-intel-19.1.3-qwmws55 --with-iconv=/apps/spack/negishi/apps/libiconv/1.16-intel-19.1.3-ti3zmh2 --without-python]])
...
local modroot="/apps/spack/negishi/apps/libxml2/2.10.1-intel-19.1.3-ifzh3dc"
