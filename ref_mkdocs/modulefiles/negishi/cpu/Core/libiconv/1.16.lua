-- -*- lua -*---
-- libiconv@1.16%gcc@8.5.0 build_system=autotools libs=shared,static arch=linux-rocky8-zen/v52nnus
--
...
local modroot="/apps/spack/negishi/apps/libiconv/1.16-gcc-8.5.0-v52nnus"
