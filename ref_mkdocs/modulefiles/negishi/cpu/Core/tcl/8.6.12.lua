-- -*- lua -*---
-- tcl@8.6.12%gcc@8.5.0 build_system=autotools arch=linux-rocky8-zen/cgwqi4p
--
...
local modroot="/apps/spack/negishi/apps/tcl/8.6.12-gcc-8.5.0-cgwqi4p"
...
setenv("RCAC_TCL_VERSION", "8.6.12")
