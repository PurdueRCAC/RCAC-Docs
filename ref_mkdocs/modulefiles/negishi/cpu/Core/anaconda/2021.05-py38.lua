-- -*- lua -*---
-- anaconda@2021.05-py38%gcc@8.5.0 build_system=generic arch=linux-rocky8-zen/rncymzu
--

whatis([[Name : anaconda]])
whatis([[Version : 2021.05-py38]])
...
local modroot="/apps/spack/negishi/apps/anaconda/2021.05-py38-gcc-8.5.0-rncymzu"
...
setenv("RCAC_ANACONDA_VERSION", "2021.05-py38")
