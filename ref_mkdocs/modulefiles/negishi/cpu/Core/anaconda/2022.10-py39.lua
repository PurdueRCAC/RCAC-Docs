-- -*- lua -*---
-- anaconda@2022.10-py39%gcc@8.5.0 build_system=generic arch=linux-rocky8-zen/sjvibry
--

whatis([[Name : anaconda]])
whatis([[Version : 2022.10-py39]])
...
local modroot="/apps/spack/negishi/apps/anaconda/2022.10-py39-gcc-8.5.0-sjvibry"
...
setenv("RCAC_ANACONDA_VERSION", "2022.10-py39")
