-- -*- lua -*---
-- xz@5.2.7%gcc@8.5.0+pic build_system=autotools libs=shared,static arch=linux-rocky8-zen/d2slvdg
--

whatis([[Name : xz]])
whatis([[Version : 5.2.7]])
...
local modroot="/apps/spack/negishi/apps/xz/5.2.7-gcc-8.5.0-d2slvdg"
