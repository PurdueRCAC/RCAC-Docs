-- -*- lua -*---
-- gdb@11.1%gcc@8.5.0+gold+ld+lto+python+quad+source-highlight+tui+xz build_system=autotools patches=7590c95 arch=linux-rocky8-zen/radc46v
--
...
whatis([[Configure options : --with-system-gdbinit=/apps/spack/negishi/apps/gdb/11.1-gcc-8.5.0-radc46v/etc/gdbinit --with-gmp=/apps/spack/negishi/apps/gmp/6.2.1-gcc-8.5.0-sh44noy --with-python=/apps/spack/negishi/apps/python/3.9.15-gcc-8.5.0-xlp3m77/bin/python3.9 LDFLAGS=-L/apps/spack/negishi/apps/python/3.9.15-gcc-8.5.0-xlp3m77/lib -lpython3.9d --enable-lto --with-quad --enable-gold --enable-ld --enable-tui]])
...
local modroot="/apps/spack/negishi/apps/gdb/11.1-gcc-8.5.0-radc46v"
