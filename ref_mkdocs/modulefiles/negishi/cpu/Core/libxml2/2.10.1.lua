-- -*- lua -*---
-- libxml2@2.10.1%gcc@8.5.0~python build_system=autotools arch=linux-rocky8-zen/syrxvuz
--
...
whatis([[Configure options : --with-lzma=/apps/spack/negishi/apps/xz/5.2.7-gcc-8.5.0-d2slvdg --with-iconv=/apps/spack/negishi/apps/libiconv/1.16-gcc-8.5.0-v52nnus --without-python]])
...
local modroot="/apps/spack/negishi/apps/libxml2/2.10.1-gcc-8.5.0-syrxvuz"
