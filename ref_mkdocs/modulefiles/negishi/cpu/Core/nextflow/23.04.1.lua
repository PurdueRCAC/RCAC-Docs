-- -*- lua -*---
-- nextflow@23.04.1%gcc@8.5.0 build_system=generic arch=linux-rocky8-zen/5nm4ta6
--

whatis([[Name : nextflow]])
whatis([[Version : 23.04.1]])
...
local modroot="/apps/spack/negishi/apps/nextflow/23.04.1-gcc-8.5.0-5nm4ta6"
...
setenv("RCAC_NEXTFLOW_VERSION", "23.04.1")
