-- -*- lua -*---
-- numactl@2.0.14%gcc@8.5.0 build_system=autotools patches=4e1d78c,62fc8a8,ff37630 arch=linux-rocky8-zen/7r7wam3
--
...
local modroot="/apps/spack/negishi/apps/numactl/2.0.14-gcc-8.5.0-7r7wam3"
