-- -*- lua -*---
-- xcb-util-image@0.4.0%gcc@8.5.0 build_system=autotools arch=linux-rocky8-zen/krf4c4n
--
...
local modroot="/apps/spack/negishi/apps/xcb-util-image/0.4.0-gcc-8.5.0-krf4c4n"
...
setenv("RCAC_XCB_UTIL_IMAGE_VERSION", "0.4.0")
