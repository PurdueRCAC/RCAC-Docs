-- -*- lua -*---
-- freetype@2.7.1%gcc@8.5.0 build_system=autotools arch=linux-rocky8-zen/kp75ecc
--
...
whatis([[Configure options : --with-brotli=no --with-bzip2=yes --with-harfbuzz=no --with-png=yes --with-zlib=no]])
...
local modroot="/apps/spack/negishi/apps/freetype/2.7.1-gcc-8.5.0-kp75ecc"
