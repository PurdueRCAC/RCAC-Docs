-- -*- lua -*---
-- gdbm@1.23%gcc@8.5.0 build_system=autotools arch=linux-rocky8-zen/kidklfz
--
...
depends_on("readline/8.1.2")

local modroot="/apps/spack/negishi/apps/gdbm/1.23-gcc-8.5.0-kidklfz"
