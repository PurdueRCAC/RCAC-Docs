...
local version = "360-2022-R2"
local app = "tecplot"
local contact = "wu979"
local license_type = "proprietary"
local modroot = "/apps/external/apps/tecplot/360-2022-R2"
...
setenv("TECHOME",modroot.."/360ex_2022r2")
setenv("TEC_360_2022",modroot.."/360ex_2022r2")
prepend_path("PATH",modroot.."/360ex_2022r2/bin")
prepend_path("PATH",modroot.."/chorus_2022r2/bin")
