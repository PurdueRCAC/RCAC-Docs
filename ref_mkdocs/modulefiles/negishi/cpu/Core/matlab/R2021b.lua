-- -*- lua -*---
-- matlab@R2021b%gcc@8.5.0 build_system=generic key=<installation-key-here> mode=silent arch=linux-rocky8-zen/ggorote
--
...
local modroot="/apps/spack/negishi/apps/matlab/R2021b-gcc-8.5.0-ggorote"
setenv("MATLAB_HOME", modroot)
setenv("RCAC_MATLAB_ROOT", modroot)
setenv("RCAC_MATLAB_VERSION", "R2021b")
