-- -*- lua -*---
-- tk@8.6.11%gcc@8.5.0+xft+xss build_system=autotools arch=linux-rocky8-zen/pq7fdff
--
...
whatis([[Configure options : --with-tcl=/apps/spack/negishi/apps/tcl/8.6.11-gcc-8.5.0-5hegc2d/lib --x-includes=/apps/spack/negishi/apps/libx11/1.7.0-gcc-8.5.0-fahe2ia/include --x-libraries=/apps/spack/negishi/apps/libx11/1.7.0-gcc-8.5.0-fahe2ia/lib --enable-xft --enable-xss]])
...
local modroot="/apps/spack/negishi/apps/tk/8.6.11-gcc-8.5.0-pq7fdff"
