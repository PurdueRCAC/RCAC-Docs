-- -*- lua -*---
-- netcdf-fortran@4.6.0%gcc@8.5.0~doc+pic+shared build_system=autotools arch=linux-rocky8-zen/w3tii2r
--
...
local modroot="/apps/spack/negishi/apps/netcdf-fortran/4.6.0-gcc-8.5.0-w3tii2r"
