local app = "cscope"
local version = "P-2019.06"
local modroot = pathJoin("/apps/external/apps/synopsys", app.."64", version)

whatis("invoke " .. "CosmosScope" .. " " .. version)
...
prepend_path("PATH",modroot.."/ai_bin")
