help([[
        This module file loads Ansys 2023R2 (2023.7; v232).
...
local ansysdir = "/apps/spack/negishi/apps/ansys/2023r2-gcc-8.5.0-6tiyzdw/ansys_inc"
local modroot = ansysdir.."/v232"
...
setenv("ANSYS232_DIR",modroot.."/ansys")
