help([[
        This module file loads Ansys 2022R2 (2022.8; v222).
...
local version = "2022R2"
local app = "ansys"
local contact = "rcac-help"
local license_type = "proprietary"
local ansysdir = "/apps/spack/negishi/apps/ansys/2022r2-gcc-8.5.0-jlisuxf/ansys_inc"
local modroot = ansysdir.."/v222"
