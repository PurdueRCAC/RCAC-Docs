-- -*- lua -*---
-- gcc@12.2.0%gcc@8.5.0~binutils+bootstrap~graphite~nvptx~piclibs~profiled~strip build_system=autotools build_type=RelWithDebInfo languages=c,c++,fortran arch=linux-rocky8-zen/27t2zcj
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu/gcc/12.2.0")
...
local modroot="/apps/spack/negishi/apps/gcc/12.2.0-gcc-8.5.0-27t2zcj"
...
setenv("RCAC_GCC_VERSION", "12.2.0")
