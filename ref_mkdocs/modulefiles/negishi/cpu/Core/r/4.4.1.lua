-- -*- lua -*---
-- r@4.4.1%gcc@12.2.0+X+external-lapack~memory_profiling+rmath build_system=autotools arch=linux-rocky8-zen3/6wqpg3g
--
...
whatis([[Configure options : --libdir=/apps/spack/negishi/apps/r/4.4.1-gcc-12.2.0-6wqpg3g/rlib --enable-R-shlib --enable-BLAS-shlib --enable-R-framework=no --without-recommended-packages LDFLAGS=-L/apps/spack/negishi/apps/r/4.4.1-gcc-12.2.0-6wqpg3g/rlib/R/lib -Wl,-rpath,/apps/spack/negishi/apps/r/4.4.1-gcc-12.2.0-6wqpg3g/rlib/R/lib --with-blas=-L/apps/spack/negishi/apps/openblas/0.3.21-gcc-12.2.0-lzvicim/lib -lopenblas --with-lapack --with-cairo --with-jpeglib --with-libpng --with-libtiff --with-tcltk --with-x --with-tcl-config=/apps/spack/negishi/apps/tcl/8.6.11-gcc-12.2.0-oktklij/lib/tclConfig.sh --with-tk-config=/apps/spack/negishi/apps/tk/8.6.11-gcc-12.2.0-grmtwvp/lib/tkConfig.sh]])
...
local modroot="/apps/spack/negishi/apps/r/4.4.1-gcc-12.2.0-6wqpg3g"
