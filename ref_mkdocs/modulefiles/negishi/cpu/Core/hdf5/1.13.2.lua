-- -*- lua -*---
-- hdf5@1.13.2%gcc@8.5.0+cxx+fortran+hl~ipo~java~mpi+shared+szip+threadsafe+tools api=default build_system=cmake build_type=RelWithDebInfo arch=linux-rocky8-zen/eaza6xl
--
...
local modroot="/apps/spack/negishi/apps/hdf5/1.13.2-gcc-8.5.0-eaza6xl"
