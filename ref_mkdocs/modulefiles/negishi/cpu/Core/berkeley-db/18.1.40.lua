-- -*- lua -*---
-- berkeley-db@18.1.40%gcc@8.5.0+cxx~docs+stl build_system=autotools patches=26090f4,b231fcc arch=linux-rocky8-zen/lzfh6ek
--
...
local modroot="/apps/spack/negishi/apps/berkeley-db/18.1.40-gcc-8.5.0-lzfh6ek"
