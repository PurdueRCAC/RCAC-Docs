-- -*- lua -*---
-- libpthread-stubs@0.4%gcc@8.5.0 build_system=autotools arch=linux-rocky8-zen/p3gcyhw
--
...
local modroot="/apps/spack/negishi/apps/libpthread-stubs/0.4-gcc-8.5.0-p3gcyhw"
