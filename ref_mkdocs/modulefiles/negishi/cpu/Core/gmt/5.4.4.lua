-- -*- lua -*---
-- gmt@5.4.4%gcc@8.5.0+blas+docs~ffmpeg+fftw+gdal+ghostscript+glib+graphicsmagick+lapack+pcre build_system=generic arch=linux-rocky8-zen/74uypt7
--
...
depends_on("imagemagick/7.0.8-7")

local modroot="/apps/spack/negishi/apps/gmt/5.4.4-gcc-8.5.0-74uypt7"
