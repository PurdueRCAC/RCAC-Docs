-- -*- lua -*---
-- libflame@5.2.0%gcc@8.5.0~debug+lapack2flame+shared+static build_system=autotools patches=bf75a5b,c5cae9e threads=none arch=linux-rocky8-zen/qyesdn7
--
...
whatis([[Configure options : LIBS=-L/apps/spack/negishi/apps/openblas/0.3.21-gcc-8.5.0-h5ga6eq/lib -lopenblas --enable-lapack2flame --enable-static-build --enable-dynamic-build --disable-debug --enable-multithreading=no --disable-supermatrix --enable-max-arg-list-hack]])
...
local modroot="/apps/spack/negishi/apps/libflame/5.2.0-gcc-8.5.0-qyesdn7"
