-- -*- lua -*---
-- netlib-lapack@3.8.0%gcc@8.5.0~external-blas~ipo+lapacke+shared~xblas build_system=cmake build_type=RelWithDebInfo patches=5c79286,ad3d41f arch=linux-rocky8-zen/77ypqk6
--
...
local modroot="/apps/spack/negishi/apps/netlib-lapack/3.8.0-gcc-8.5.0-77ypqk6"
