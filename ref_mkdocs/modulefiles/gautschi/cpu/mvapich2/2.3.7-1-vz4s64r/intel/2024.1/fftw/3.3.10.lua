-- -*- lua -*---
-- fftw@3.3.10%oneapi@2024.1.0+mpi~openmp~pfft_patches+shared build_system=autotools precision=double,float arch=linux-rocky9-zen4/e6pgb24
--
...
local modroot="/apps/spack/gautschi-cpu/apps/fftw/3.3.10-oneapi-2024.1.0-e6pgb24"
