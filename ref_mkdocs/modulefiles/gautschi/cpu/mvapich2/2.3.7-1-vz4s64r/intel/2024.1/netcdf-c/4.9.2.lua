-- -*- lua -*---
-- netcdf-c@4.9.2%oneapi@2024.1.0+blosc~byterange~dap~fsync~hdf4~jna~logging+mpi~nczarr_zip+optimize~parallel-netcdf+pic+shared+szip+zstd build_system=autotools patches=0161eb8 arch=linux-rocky9-zen4/xmjnu3i
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-c/4.9.2-oneapi-2024.1.0-xmjnu3i"
