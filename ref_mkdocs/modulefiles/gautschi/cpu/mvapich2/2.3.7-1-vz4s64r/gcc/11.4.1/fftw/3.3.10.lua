-- -*- lua -*---
-- fftw@3.3.10%gcc@11.4.1+mpi~openmp~pfft_patches+shared build_system=autotools patches=872cff9 precision=double,float arch=linux-rocky9-zen4/tqbl6hy
--
...
local modroot="/apps/spack/gautschi-cpu/apps/fftw/3.3.10-gcc-11.4.1-tqbl6hy"
