-- -*- lua -*---
-- netcdf-fortran@4.6.1%gcc@11.4.1~doc+pic+shared build_system=autotools arch=linux-rocky9-zen4/f32vkmc
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-fortran/4.6.1-gcc-11.4.1-f32vkmc"
