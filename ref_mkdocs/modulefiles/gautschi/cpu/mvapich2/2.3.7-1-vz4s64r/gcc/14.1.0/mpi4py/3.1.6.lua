-- -*- lua -*---
-- py-mpi4py@3.1.6%gcc@14.1.0 build_system=python_pip arch=linux-rocky9-zen4/ge3pl5m
--
...
local modroot="/apps/spack/gautschi-cpu/apps/py-mpi4py/3.1.6-gcc-14.1.0-ge3pl5m"
