-- -*- lua -*---
-- parallel-netcdf@1.12.3%gcc@14.1.0~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky9-zen4/ldb6k6a
--
...
local modroot="/apps/spack/gautschi-cpu/apps/parallel-netcdf/1.12.3-gcc-14.1.0-ldb6k6a"
