-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@14.1.0~doc~ipo+pic+shared~tests build_system=cmake build_type=Release generator=make arch=linux-rocky9-zen4/eos4o46
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-cxx4/4.3.1-gcc-14.1.0-eos4o46"
