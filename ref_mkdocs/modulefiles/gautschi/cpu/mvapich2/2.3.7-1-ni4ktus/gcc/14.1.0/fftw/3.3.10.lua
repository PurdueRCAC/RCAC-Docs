-- -*- lua -*---
-- fftw@3.3.10%gcc@14.1.0+mpi~openmp~pfft_patches+shared build_system=autotools precision=double,float arch=linux-rocky9-zen4/pe6tjbs
--
...
local modroot="/apps/spack/gautschi-cpu/apps/fftw/3.3.10-gcc-14.1.0-pe6tjbs"
