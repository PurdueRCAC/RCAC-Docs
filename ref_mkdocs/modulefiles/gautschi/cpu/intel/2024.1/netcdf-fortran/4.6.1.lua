-- -*- lua -*---
-- netcdf-fortran@4.6.1%oneapi@2024.1.0~doc+pic+shared build_system=autotools arch=linux-rocky9-zen4/jjr3rxk
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-fortran/4.6.1-oneapi-2024.1.0-jjr3rxk"
