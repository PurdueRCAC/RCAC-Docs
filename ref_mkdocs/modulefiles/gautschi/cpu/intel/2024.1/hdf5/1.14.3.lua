-- -*- lua -*---
-- hdf5@1.14.3%oneapi@2024.1.0~cxx~fortran+hl~ipo~java~map~mpi+shared~szip~threadsafe+tools api=default build_system=cmake build_type=Release generator=make patches=82088c8 arch=linux-rocky9-zen4/6xqqekk
--
...
local modroot="/apps/spack/gautschi-cpu/apps/hdf5/1.14.3-oneapi-2024.1.0-jlwi34m"
