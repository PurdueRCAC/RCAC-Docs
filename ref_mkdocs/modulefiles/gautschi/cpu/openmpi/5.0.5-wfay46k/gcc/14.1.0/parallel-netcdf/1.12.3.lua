-- -*- lua -*---
-- parallel-netcdf@1.12.3%gcc@14.1.0~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky9-zen4/bhtofre
--
...
whatis([[Configure options : --with-mpi=/apps/spack/gautschi-cpu/apps/openmpi/5.0.5-gcc-14.1.0-wfay46k SEQ_CC=/apps/spack/gautschi-cpu/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC -fallow-argument-mismatch FFLAGS=-fPIC -fallow-argument-mismatch --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/gautschi-cpu/apps/parallel-netcdf/1.12.3-gcc-14.1.0-bhtofre"
