-- -*- lua -*---
-- parallel-netcdf@1.12.3%gcc@11.4.1~burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky9-zen4/6vmmh7w
--
...
whatis([[Configure options : --with-mpi=/apps/spack/gautschi-cpu/apps/openmpi/4.1.6-gcc-11.4.1-mjnxdbr SEQ_CC=/apps/spack/gautschi-cpu/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC -fallow-argument-mismatch FFLAGS=-fPIC -fallow-argument-mismatch --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/gautschi-cpu/apps/parallel-netcdf/1.12.3-gcc-11.4.1-6vmmh7w"
