-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@11.4.1~doc~ipo+pic+shared~tests build_system=cmake build_type=Release generator=make arch=linux-rocky9-zen4/xcgrk5p
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-cxx4/4.3.1-gcc-11.4.1-xcgrk5p"
