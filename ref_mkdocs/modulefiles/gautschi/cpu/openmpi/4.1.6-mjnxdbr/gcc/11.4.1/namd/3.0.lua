-- -*- lua -*---
-- namd@3.0%gcc@11.4.1~avxtiles~cuda~memopt~rocm~single_node_gpu build_system=makefile fftw=3 interface=tcl arch=linux-rocky9-zen4/niikik4
--
...
local modroot="/apps/spack/gautschi-cpu/apps/namd/3.0-gcc-11.4.1-niikik4"
