-- -*- lua -*---
-- gromacs@2024.3%gcc@14.1.0~cp2k~cuda~cycle_subcounters~double+gmxapi+hwloc~intel_provided_gcc~ipo~mdrun_only+mpi+nblib~nosuffix~opencl+openmp~relaxed_double_precision+shared~sycl build_system=cmake build_type=Release generator=make openmp_max_threads=none arch=linux-rocky9-zen4/rvmshf7
--
...
local modroot="/apps/spack/gautschi-cpu/apps/gromacs/2024.3-gcc-14.1.0-rvmshf7"
