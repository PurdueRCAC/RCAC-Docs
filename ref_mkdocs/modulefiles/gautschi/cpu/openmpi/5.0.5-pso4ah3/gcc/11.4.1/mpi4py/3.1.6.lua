-- -*- lua -*---
-- py-mpi4py@3.1.6%gcc@11.4.1 build_system=python_pip arch=linux-rocky9-zen4/zk6k3tq
--
...
local modroot="/apps/spack/gautschi-cpu/apps/py-mpi4py/3.1.6-gcc-11.4.1-zk6k3tq"
