-- -*- lua -*---
-- fftw@3.3.10%gcc@11.4.1+mpi~openmp~pfft_patches+shared build_system=autotools precision=double,float arch=linux-rocky9-zen4/62imyak
--
...
local modroot="/apps/spack/gautschi-cpu/apps/fftw/3.3.10-gcc-11.4.1-62imyak"
