-- -*- lua -*---
-- netcdf-cxx4@4.3.1%oneapi@2024.1.0~doc~ipo+pic+shared~tests build_system=cmake build_type=Release generator=make arch=linux-rocky9-zen4/axrcxq6
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-cxx4/4.3.1-oneapi-2024.1.0-axrcxq6"
