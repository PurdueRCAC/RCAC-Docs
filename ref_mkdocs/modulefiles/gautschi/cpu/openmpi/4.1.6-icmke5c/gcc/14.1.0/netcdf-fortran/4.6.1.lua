-- -*- lua -*---
-- netcdf-fortran@4.6.1%gcc@14.1.0~doc+pic+shared build_system=autotools arch=linux-rocky9-zen4/rtmve3n
--
...
local modroot="/apps/spack/gautschi-cpu/apps/netcdf-fortran/4.6.1-gcc-14.1.0-rtmve3n"
