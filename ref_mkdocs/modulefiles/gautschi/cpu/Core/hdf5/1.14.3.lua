-- -*- lua -*---
-- hdf5@1.14.3%gcc@11.4.1~cxx~fortran+hl~ipo~java~map~mpi+shared~szip~threadsafe+tools api=default build_system=cmake build_type=Release generator=make patches=82088c8 arch=linux-rocky9-zen4/q6dfyct
--
...
local modroot="/apps/spack/gautschi-cpu/apps/hdf5/1.14.3-gcc-11.4.1-q6dfyct"
