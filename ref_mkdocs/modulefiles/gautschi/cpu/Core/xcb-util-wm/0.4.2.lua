-- -*- lua -*---
-- xcb-util-wm@0.4.2%gcc@11.4.1 build_system=autotools arch=linux-rocky9-zen4/bb2u3wb
--
...
local modroot="/apps/spack/gautschi-cpu/apps/xcb-util-wm/0.4.2-gcc-11.4.1-bb2u3wb"
...
setenv("RCAC_XCB_UTIL_WM_VERSION", modroot)
