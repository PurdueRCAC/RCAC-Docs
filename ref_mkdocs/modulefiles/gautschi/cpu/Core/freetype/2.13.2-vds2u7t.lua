-- -*- lua -*---
-- freetype@2.13.2%gcc@11.4.1+pic+shared build_system=autotools arch=linux-rocky9-zen4/vds2u7t
--
...
depends_on("libpng/1.6.39-q7jm2rg")

local modroot="/apps/spack/gautschi-cpu/apps/freetype/2.13.2-gcc-11.4.1-vds2u7t"
