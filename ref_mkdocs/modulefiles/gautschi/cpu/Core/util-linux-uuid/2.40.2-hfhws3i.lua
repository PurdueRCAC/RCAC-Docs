-- -*- lua -*---
-- util-linux-uuid@2.40.2%gcc@11.4.1 build_system=autotools arch=linux-rocky9-zen4/hfhws3i
--

whatis([[Name : util-linux-uuid]])
whatis([[Version : 2.40.2]])
...
local modroot="/apps/spack/gautschi-cpu/apps/util-linux-uuid/2.40.2-gcc-11.4.1-hfhws3i"
