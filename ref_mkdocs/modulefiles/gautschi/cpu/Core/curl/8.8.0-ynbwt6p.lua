-- -*- lua -*---
-- curl@8.8.0%gcc@11.4.1~gssapi~ldap~libidn2~librtmp~libssh~libssh2+nghttp2 build_system=autotools libs=shared,static tls=openssl arch=linux-rocky9-zen4/ynbwt6p
--
...
local modroot="/apps/spack/gautschi-cpu/apps/curl/8.8.0-gcc-11.4.1-ynbwt6p"
