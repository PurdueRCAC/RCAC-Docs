-- -*- lua -*---
-- xcb-util-keysyms@0.4.1%gcc@11.4.1 build_system=autotools arch=linux-rocky9-zen4/vvfbz3z
--
...
local modroot="/apps/spack/gautschi-cpu/apps/xcb-util-keysyms/0.4.1-gcc-11.4.1-vvfbz3z"
...
setenv("RCAC_XCB_UTIL_KEYSYMS_VERSION", modroot)
