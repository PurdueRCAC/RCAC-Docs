-- -*- lua -*---
-- py-matplotlib@3.9.0%gcc@11.4.1~animation~fonts~latex~movies backend=agg build_system=python_pip arch=linux-rocky9-zen4/d6epans
--
...
local modroot="/apps/spack/gautschi-cpu/apps/py-matplotlib/3.9.0-gcc-11.4.1-d6epans"
