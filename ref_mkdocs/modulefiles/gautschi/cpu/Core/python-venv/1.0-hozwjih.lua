-- -*- lua -*---
-- python-venv@1.0%gcc@11.4.1 build_system=generic arch=linux-rocky9-zen4/hozwjih
--
...
local modroot="/apps/spack/gautschi-cpu/apps/python-venv/1.0-gcc-11.4.1-hozwjih"
