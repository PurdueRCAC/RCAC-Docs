-- -*- lua -*---
-- mvapich2@2.3.7-1%gcc@11.4.1~alloca~cuda~debug~hwloc_graphics~hwlocv2+regcache+wrapperrpath build_system=autotools ch3_rank_bits=32 fabrics=mrail file_systems=auto patches=750f9f2,d98d8e7 process_managers=auto threads=multiple arch=linux-rocky9-zen4/vz4s64r
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu/mvapich2/2.3.7-1-vz4s64r/gcc/11.4.1")
...
setenv("LMOD_MPI_VERSION", "2.3.7-1-vz4s64r")

depends_on("libxml2/2.10.3-4drlclc")

local modroot="/apps/spack/gautschi-cpu/apps/mvapich2/2.3.7-1-gcc-11.4.1-vz4s64r"
