...
prepend_path("MODULEPATH", "/opt/spack/cpu/openmpi/5.0.5-pso4ah3/gcc/11.4.1")
...
setenv("LMOD_MPI_VERSION", "5.0.5-pso4ah3")


local modroot="/apps/spack/gautschi-cpu/apps/openmpi/5.0.5-gcc-11.4.1-pso4ah3"
