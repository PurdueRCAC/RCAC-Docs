...
prepend_path("MODULEPATH", "/opt/spack/cpu/openmpi/4.1.6-mjnxdbr/gcc/11.4.1")
...
setenv("LMOD_MPI_VERSION", "4.1.6-mjnxdbr")


local modroot="/apps/spack/gautschi-cpu/apps/openmpi/4.1.6-gcc-11.4.1-mjnxdbr"
