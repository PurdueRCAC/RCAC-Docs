-- -*- lua -*---
-- py-pandas@2.2.2%gcc@14.1.0~excel~performance build_system=python_pip arch=linux-rocky9-zen4/sr5yop6
--
...
local modroot="/apps/spack/gautschi-cpu/apps/py-pandas/2.2.2-gcc-14.1.0-sr5yop6"
