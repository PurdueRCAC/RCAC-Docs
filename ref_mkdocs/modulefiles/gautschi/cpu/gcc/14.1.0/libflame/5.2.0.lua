-- -*- lua -*---
-- libflame@5.2.0%gcc@14.1.0~debug+lapack2flame+shared+static build_system=autotools patches=bf75a5b,c5cae9e threads=none arch=linux-rocky9-zen4/a2n6x3r
--
...
whatis([[Configure options : LIBS=-L/apps/spack/gautschi-cpu/apps/openblas/0.3.27-gcc-11.4.1-kmti2ku/lib -lopenblas --enable-lapack2flame --enable-static-build --enable-dynamic-build --disable-debug --enable-multithreading=no --disable-supermatrix --enable-max-arg-list-hack]])
...
local modroot="/apps/spack/gautschi-cpu/apps/libflame/5.2.0-gcc-14.1.0-a2n6x3r"
