-- -*- lua -*---
-- hdf5@1.14.3%gcc@14.1.0~cxx~fortran+hl~ipo~java~map~mpi+shared~szip~threadsafe+tools api=default build_system=cmake build_type=Release generator=make patches=82088c8 arch=linux-rocky9-zen4/fkeoglh
--
...
local modroot="/apps/spack/gautschi-cpu/apps/hdf5/1.14.3-gcc-14.1.0-k2dbjbc"
