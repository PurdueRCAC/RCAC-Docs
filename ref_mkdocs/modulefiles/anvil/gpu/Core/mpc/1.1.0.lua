...
whatis([[Configure options : --with-mpfr=/apps/spack/anvilgpu/apps/mpfr/4.0.2-gcc-8.4.1-zqh4s5a --with-gmp=/apps/spack/anvilgpu/apps/gmp/6.2.1-gcc-8.4.1-a4uy3yg]])
...
local modroot="/apps/spack/anvilgpu/apps/mpc/1.1.0-gcc-8.4.1-dh4xij5"
