-- -*- lua -*---
-- openblas@0.3.17%gcc@8.4.1~bignuma~consistent_fpcsr~ilp64+locking+pic+shared threads=openmp arch=linux-centos8-zen/wvfkgfh
--
...
local modroot="/apps/spack/anvilgpu/apps/openblas/0.3.17-gcc-8.4.1-wvfkgfh"
