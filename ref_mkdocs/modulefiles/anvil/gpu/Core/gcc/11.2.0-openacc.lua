-- -*- lua -*---
-- gcc@11.2.0%gcc@8.4.1~binutils~bootstrap~graphite+nvptx~piclibs~strip languages=c,c++,fortran arch=linux-centos8-zen/c5u5vih
--
...
local modroot="/apps/spack/anvilgpu/apps/gcc/11.2.0-gcc-8.4.1-c5u5vih"
