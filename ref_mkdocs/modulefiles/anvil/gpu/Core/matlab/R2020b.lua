-- -*- lua -*---
-- matlab@R2020b%gcc@8.4.1 key=<installation-key-here> mode=silent arch=linux-centos8-zen/ybog64f
--
...
local modroot="/apps/spack/anvil/apps/matlab/R2020b-gcc-8.4.1-ybog64f"
setenv("MATLAB_HOME", modroot)
setenv("RCAC_MATLAB_ROOT", modroot)
setenv("RCAC_MATLAB_VERSION", "R2020b")
