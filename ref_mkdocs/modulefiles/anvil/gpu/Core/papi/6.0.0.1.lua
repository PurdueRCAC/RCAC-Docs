-- -*- lua -*---
-- papi@6.0.0.1%gcc@8.4.1+cuda+example+infiniband+lmsensors~nvml~powercap+rapl+sde+shared~static_tools arch=linux-centos8-zen/e4xzc2n
--
...
whatis([[Configure options : MPICC=: --with-components=example infiniband rapl lmsensors sde cuda --with-shared-lib=yes]])
...
local modroot="/apps/spack/anvilgpu/apps/papi/6.0.0.1-gcc-8.4.1-e4xzc2n"
...
setenv("PAPI_LMSENSORS_ROOT", "/apps/spack/anvilgpu/apps/lm-sensors/3-6-0-gcc-8.4.1-guezjmc")
setenv("PAPI_CUDA_ROOT", "/apps/anvilgpu/external/apps/cuda-toolkit/11.2.2")
