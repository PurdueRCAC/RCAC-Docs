...
whatis([[Configure options : --with-tcl=/apps/spack/anvilgpu/apps/tcl/8.6.11-gcc-8.4.1-btsikwx/lib --x-includes=/apps/spack/anvilgpu/apps/libx11/1.7.0-gcc-8.4.1-mb6lkqi/include --x-libraries=/apps/spack/anvilgpu/apps/libx11/1.7.0-gcc-8.4.1-mb6lkqi/lib --enable-xft --enable-xss]])
...
local modroot="/apps/spack/anvilgpu/apps/tk/8.6.11-gcc-8.4.1-e6pa5lo"
