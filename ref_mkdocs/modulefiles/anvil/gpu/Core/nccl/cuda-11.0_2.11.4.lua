-- -*- lua -*---
-- nccl@cuda-11.0_2.11.4%gcc@8.4.1+cuda cuda_arch=none arch=linux-centos8-zen/twcmtpp
--

whatis([[Name : nccl]])
whatis([[Version : cuda-11.0_2.11.4]])
...
local modroot="/apps/anvilgpu/external/apps/nccl/cuda11.0/2.11.4"
...
setenv("RCAC_NCCL_VERSION", "cuda-11.0_2.11.4")
