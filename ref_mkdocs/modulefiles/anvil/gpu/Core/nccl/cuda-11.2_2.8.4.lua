-- -*- lua -*---
-- nccl@cuda-11.2_2.8.4%gcc@8.4.1+cuda cuda_arch=none arch=linux-centos8-zen/m5ycoum
--

whatis([[Name : nccl]])
whatis([[Version : cuda-11.2_2.8.4]])
...
local modroot="/apps/anvilgpu/external/apps/nccl/cuda11.2/2.8.4"
...
setenv("RCAC_NCCL_VERSION", "cuda-11.2_2.8.4")
