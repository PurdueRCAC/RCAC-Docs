...
whatis([[Configure options : --with-lzma=/apps/spack/anvilgpu/apps/xz/5.2.5-gcc-8.4.1-z5hcyk3 --with-iconv=/apps/spack/anvilgpu/apps/libiconv/1.16-gcc-8.4.1-yfiuybb --without-python]])
...
local modroot="/apps/spack/anvilgpu/apps/libxml2/2.9.10-gcc-8.4.1-nqf25ct"
