-- -*- lua -*---
-- netcdf-fortran@4.5.3%gcc@8.4.1~doc+pic+shared arch=linux-centos8-zen/nvk5xso
--
...
local modroot="/apps/spack/anvilgpu/apps/netcdf-fortran/4.5.3-gcc-8.4.1-nvk5xso"
