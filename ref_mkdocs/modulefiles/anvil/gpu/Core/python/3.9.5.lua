...
-- numba
prepend_path('PYTHONPATH', prefix .. '/py-numba/0.51.1-gcc-8.4.1-i7pre2e/lib/python3.9/site-packages')
prepend_path('PYTHONPATH', prefix .. '/py-llvmlite/0.37.0-gcc-8.4.1-cemtjkq/lib/python3.9/site-packages')
