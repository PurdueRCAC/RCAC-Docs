-- -*- lua -*---
-- netcdf-fortran@4.5.3%gcc@11.2.0~doc+pic+shared arch=linux-centos8-zen3/pexvwnv
--
...
local modroot="/apps/spack/anvilgpu/apps/netcdf-fortran/4.5.3-gcc-11.2.0-pexvwnv"
