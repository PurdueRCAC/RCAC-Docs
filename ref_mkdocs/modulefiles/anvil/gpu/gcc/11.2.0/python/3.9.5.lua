...
-- numba
prepend_path('PYTHONPATH', prefix .. '/py-numba/0.51.1-gcc-11.2.0-hv4wot5/lib/python3.9/site-packages')
prepend_path('PYTHONPATH', prefix .. '/py-llvmlite/0.37.0-gcc-11.2.0-ks32lia/lib/python3.9/site-packages')
