-- -*- lua -*---
-- hwloc@1.11.13%gcc@11.2.0~cairo+cuda~gl~libudev+libxml2~netloc~nvml~opencl+pci~rocm+shared patches=d1d94a4af93486c88c70b79cd930979f3a2a2b5843708e8c7c1655f18b9fc694 arch=linux-centos8-zen3/3q5q4yv
--

whatis([[Name : hwloc]])
whatis([[Version : 1.11.13]])
whatis([[Short description : The Hardware Locality (hwloc) software project.]])
whatis([[Configure options : --disable-opencl --disable-cairo --disable-nvml --disable-gl --enable-cuda --enable-libxml2 --disable-libudev --enable-pci --enable-shared]])
...
local modroot="/apps/spack/anvilgpu/apps/hwloc/1.11.13-gcc-11.2.0-3q5q4yv"
