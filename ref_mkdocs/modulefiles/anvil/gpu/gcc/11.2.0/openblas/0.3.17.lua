-- -*- lua -*---
-- openblas@0.3.17%gcc@11.2.0~bignuma~consistent_fpcsr~ilp64+locking+pic+shared threads=openmp arch=linux-centos8-zen3/2qrsari
--
...
local modroot="/apps/spack/anvilgpu/apps/openblas/0.3.17-gcc-11.2.0-2qrsari"
