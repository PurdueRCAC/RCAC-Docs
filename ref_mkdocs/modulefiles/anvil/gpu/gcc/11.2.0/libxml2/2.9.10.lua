-- -*- lua -*---
-- libxml2@2.9.10%gcc@11.2.0~python arch=linux-centos8-zen3/k7dtqsx
--
...
whatis([[Configure options : --with-lzma=/apps/spack/anvilgpu/apps/xz/5.2.5-gcc-11.2.0-5r24vrj --with-iconv=/apps/spack/anvilgpu/apps/libiconv/1.16-gcc-11.2.0-nrbprxy --without-python]])
...
local modroot="/apps/spack/anvilgpu/apps/libxml2/2.9.10-gcc-11.2.0-k7dtqsx"
