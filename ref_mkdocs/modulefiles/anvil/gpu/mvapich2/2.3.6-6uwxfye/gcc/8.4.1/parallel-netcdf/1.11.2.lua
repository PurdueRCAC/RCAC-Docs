-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.4.1~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen/mmiyii2
--
...
whatis([[Configure options : --with-mpi=/apps/spack/anvilgpu/apps/mvapich2/2.3.6-gcc-8.4.1-6uwxfye SEQ_CC=/apps/spack/anvilgpu/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC FFLAGS=-fPIC --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/anvilgpu/apps/parallel-netcdf/1.11.2-gcc-8.4.1-mmiyii2"
