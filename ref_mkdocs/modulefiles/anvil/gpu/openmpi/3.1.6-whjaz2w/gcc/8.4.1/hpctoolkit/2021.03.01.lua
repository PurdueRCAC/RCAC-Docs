-- -*- lua -*---
-- hpctoolkit@2021.03.01%gcc@8.4.1~all-static~cray+cuda~debug+mpi+papi~rocm+viewer arch=linux-centos8-zen/qnereqy
--
...
local modroot="/apps/spack/anvilgpu/apps/hpctoolkit/2021.03.01-gcc-8.4.1-qnereqy"
