-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.4.1~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen/cqemw7q
--
...
whatis([[Configure options : --with-mpi=/apps/spack/anvilgpu/apps/openmpi/3.1.6-gcc-8.4.1-whjaz2w SEQ_CC=/apps/spack/anvilgpu/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC FFLAGS=-fPIC --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/anvilgpu/apps/parallel-netcdf/1.11.2-gcc-8.4.1-cqemw7q"
