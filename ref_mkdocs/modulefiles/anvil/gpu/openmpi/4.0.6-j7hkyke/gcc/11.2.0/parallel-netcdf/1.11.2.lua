-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@11.2.0~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen3/mrrasoh
--
...
whatis([[Configure options : --with-mpi=/apps/spack/anvilgpu/apps/openmpi/4.0.6-gcc-11.2.0-j7hkyke SEQ_CC=/apps/spack/anvilgpu/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC -fallow-argument-mismatch FFLAGS=-fPIC -fallow-argument-mismatch --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/anvilgpu/apps/parallel-netcdf/1.11.2-gcc-11.2.0-mrrasoh"
