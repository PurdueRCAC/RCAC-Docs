-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@11.2.0+doxygen+pic+shared+static arch=linux-centos8-zen3/zab73wm
--
...
local modroot="/apps/spack/anvilgpu/apps/netcdf-cxx4/4.3.1-gcc-11.2.0-zab73wm"
