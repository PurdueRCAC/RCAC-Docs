-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@8.4.1+doxygen+pic+shared+static arch=linux-centos8-zen/j33pbz2
--
...
local modroot="/apps/spack/anvilgpu/apps/netcdf-cxx4/4.3.1-gcc-8.4.1-j33pbz2"
