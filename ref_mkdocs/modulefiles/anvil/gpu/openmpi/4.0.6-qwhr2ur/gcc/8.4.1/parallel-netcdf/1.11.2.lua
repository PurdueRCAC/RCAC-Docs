-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.4.1~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen/kaffwta
--
...
whatis([[Configure options : --with-mpi=/apps/spack/anvilgpu/apps/openmpi/4.0.6-gcc-8.4.1-qwhr2ur SEQ_CC=/apps/spack/anvilgpu/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC FFLAGS=-fPIC --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/anvilgpu/apps/parallel-netcdf/1.11.2-gcc-8.4.1-kaffwta"
