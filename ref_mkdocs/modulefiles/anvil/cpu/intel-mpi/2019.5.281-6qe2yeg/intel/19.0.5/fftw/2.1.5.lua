-- -*- lua -*---
-- fftw@2.1.5%intel@19.0.5+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen2/g7befbs
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-intel-19.0.5-g7befbs"
