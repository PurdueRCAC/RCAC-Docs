-- -*- lua -*---
-- parallel-netcdf@1.11.2%intel@19.1.3~burstbuffer+cxx+fortran+pic+shared arch=linux-rocky8-zen2/dz3cy47
--
...
whatis([[Configure options : --with-mpi=/apps/anvil/external/apps/intel/cluster.2020.4 SEQ_CC=/apps/spack/anvil/framework/spack/lib/spack/env/intel/icc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC FFLAGS=-fPIC --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-intel-19.1.3-dz3cy47"
