-- -*- lua -*---
-- blis@0.8.1%aocc@3.1.0+blas+cblas+shared+static threads=openmp arch=linux-centos8-zen3/ieq6lcv
--
...
local modroot="/apps/spack/anvil/apps/blis/0.8.1-aocc-3.1.0-ieq6lcv"
