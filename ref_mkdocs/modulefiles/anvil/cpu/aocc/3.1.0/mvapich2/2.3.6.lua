-- -*- lua -*---
-- mvapich2@2.3.6%aocc@3.1.0~alloca~cuda~debug+regcache+wrapperrpath ch3_rank_bits=32 fabrics=mrail file_systems=auto process_managers=auto threads=multiple arch=linux-centos8-zen3/hqg725h
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/mvapich2/2.3.6-hqg725h/aocc/3.1.0")
...
setenv("LMOD_MPI_VERSION", "2.3.6-hqg725h")

depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/mvapich2/2.3.6-aocc-3.1.0-hqg725h"
