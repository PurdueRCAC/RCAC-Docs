-- -*- lua -*---
-- mpfr@4.0.2%aocc@3.1.0 patches=3f80b836948aa96f8d1cb9cc7f3f55973f19285482a96f9a4e1623d460bcccf0 arch=linux-centos8-zen3/ngfa7vp
--
...
whatis([[Configure options : --with-gmp=/apps/spack/anvil/apps/gmp/6.2.1-aocc-3.1.0-ktykeq7]])
...
local modroot="/apps/spack/anvil/apps/mpfr/4.0.2-aocc-3.1.0-ngfa7vp"
