-- -*- lua -*---
-- fftw@3.3.8%aocc@3.1.0~mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen3/tdyeptn
--
...
local modroot="/apps/spack/anvil/apps/fftw/3.3.8-aocc-3.1.0-tdyeptn"
