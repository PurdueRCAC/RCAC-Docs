-- -*- lua -*---
-- tk@8.6.11%aocc@3.1.0+xft+xss arch=linux-centos8-zen3/5uu4psc
--
...
whatis([[Configure options : --with-tcl=/apps/spack/anvil/apps/tcl/8.6.11-aocc-3.1.0-fqmteqv/lib --x-includes=/apps/spack/anvil/apps/libx11/1.7.0-aocc-3.1.0-eklwgk5/include --x-libraries=/apps/spack/anvil/apps/libx11/1.7.0-aocc-3.1.0-eklwgk5/lib --enable-xft --enable-xss]])
...
local modroot="/apps/spack/anvil/apps/tk/8.6.11-aocc-3.1.0-5uu4psc"
