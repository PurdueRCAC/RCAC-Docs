-- -*- lua -*---
-- netcdf-cxx4@4.3.1%aocc@3.1.0+doxygen+pic+shared+static arch=linux-centos8-zen3/bwik52g
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-aocc-3.1.0-bwik52g"
