-- -*- lua -*---
-- openmpi@4.1.6%aocc@3.1.0~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-rocky8-zen3/qr25guq
--

whatis([[Name : openmpi]])
whatis([[Version : 4.1.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-aocc-3.1.0-au56zhk --enable-mpi1-compatibility --without-alps --without-tm --with-slurm --without-loadleveler --without-lsf --without-sge --disable-memchecker --with-libevent=/apps/spack/anvil/apps/libevent/2.1.12-aocc-3.1.0-j73yxn2 --with-hwloc=/apps/spack/anvil/apps/hwloc/2.5.0-aocc-3.1.0-jzjdyfh --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions --with-wrapper-ldflags=-Wl,-rpath,/apps/spack/anvil/apps/aocc/3.1.0-gcc-8.4.1-nyeeeca/lib]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu/openmpi/4.1.6-qr25guq/aocc/3.1.0")
...
setenv("LMOD_MPI_VERSION", "4.1.6-qr25guq")

depends_on("numactl/2.0.14")
depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/openmpi/4.1.6-aocc-3.1.0-qr25guq"
