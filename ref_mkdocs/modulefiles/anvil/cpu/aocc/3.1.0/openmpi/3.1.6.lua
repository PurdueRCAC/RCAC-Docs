-- -*- lua -*---
-- openmpi@3.1.6%aocc@3.1.0~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-centos8-zen3/ccda6nw
--

whatis([[Name : openmpi]])
whatis([[Version : 3.1.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-aocc-3.1.0-7cq3asl --without-sge --without-loadleveler --without-tm --without-lsf --with-slurm --without-alps --disable-memchecker --with-hwloc=/apps/spack/anvil/apps/hwloc/1.11.13-aocc-3.1.0-vjzgbdl --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions --with-wrapper-ldflags=-Wl,-rpath,/apps/spack/anvil/apps/aocc/3.1.0-gcc-8.4.1-nyeeeca/lib]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/openmpi/3.1.6-ccda6nw/aocc/3.1.0")
...
setenv("LMOD_MPI_VERSION", "3.1.6-ccda6nw")
...
local modroot="/apps/spack/anvil/apps/openmpi/3.1.6-aocc-3.1.0-ccda6nw"
