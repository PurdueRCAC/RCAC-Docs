-- -*- lua -*---
-- intel-mpi@2019.9.304%intel@19.1.3 arch=linux-rocky8-zen2/5h4cahe
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu/intel-mpi/2019.9.304-5h4cahe/intel/19.1.3")
...
setenv("LMOD_MPI_VERSION", "2019.9.304-5h4cahe")
