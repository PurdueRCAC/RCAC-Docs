-- -*- lua -*---
-- mvapich2@2.3.6%intel@19.1.3~alloca~cuda~debug+regcache+wrapperrpath ch3_rank_bits=32 fabrics=mrail file_systems=auto process_managers=auto threads=multiple arch=linux-rocky8-zen2/kno4mph
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu/mvapich2/2.3.6-kno4mph/intel/19.1.3")
...
setenv("LMOD_MPI_VERSION", "2.3.6-kno4mph")

depends_on("libxml2/2.9.10")
depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/mvapich2/2.3.6-intel-19.1.3-kno4mph"
