-- -*- lua -*---
-- netcdf-c@4.7.4%intel@19.1.3~dap~fsync+hdf4~jna~mpi~parallel-netcdf+pic+shared arch=linux-rocky8-zen2/sa4xm3b
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-intel-19.1.3-sa4xm3b"
