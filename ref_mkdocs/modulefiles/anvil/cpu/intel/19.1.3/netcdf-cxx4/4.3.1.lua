-- -*- lua -*---
-- netcdf-cxx4@4.3.1%intel@19.1.3+doxygen+pic+shared+static arch=linux-rocky8-zen2/riqxcz5
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-intel-19.1.3-riqxcz5"
