-- -*- lua -*---
-- openmpi@4.0.6%intel@19.0.5~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-centos8-zen2/gg3uqqz
--

whatis([[Name : openmpi]])
whatis([[Version : 4.0.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-intel-19.0.5-v2223dl --enable-mpi1-compatibility --without-sge --without-tm --without-loadleveler --without-alps --with-slurm --without-lsf --disable-memchecker --with-libevent=/apps/spack/anvil/apps/libevent/2.1.12-intel-19.0.5-zyc46z2 --with-hwloc=/apps/spack/anvil/apps/hwloc/2.5.0-intel-19.0.5-hjxqk75 --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions --with-wrapper-ldflags=-Wl,-rpath,/apps/anvil/external/apps/intel/cluster.2019.5/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64_lin]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/openmpi/4.0.6-gg3uqqz/intel/19.0.5")
...
setenv("LMOD_MPI_VERSION", "4.0.6-gg3uqqz")

depends_on("libfabric/1.12.0")
depends_on("numactl/2.0.14")
depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/openmpi/4.0.6-intel-19.0.5-gg3uqqz"
