-- -*- lua -*---
-- openmpi@3.1.6%intel@19.0.5~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-centos8-zen2/u3lei5g
--

whatis([[Name : openmpi]])
whatis([[Version : 3.1.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-intel-19.0.5-v2223dl --without-alps --with-slurm --without-lsf --without-loadleveler --without-tm --without-sge --disable-memchecker --with-hwloc=/apps/spack/anvil/apps/hwloc/1.11.13-intel-19.0.5-j7wiwcd --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions --with-wrapper-ldflags=-Wl,-rpath,/apps/anvil/external/apps/intel/cluster.2019.5/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64_lin]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/openmpi/3.1.6-u3lei5g/intel/19.0.5")
...
setenv("LMOD_MPI_VERSION", "3.1.6-u3lei5g")
...
local modroot="/apps/spack/anvil/apps/openmpi/3.1.6-intel-19.0.5-u3lei5g"
