-- -*- lua -*---
-- libxml2@2.9.10%intel@19.0.5~python arch=linux-centos8-zen2/et26472
--
...
whatis([[Configure options : --with-lzma=/apps/spack/anvil/apps/xz/5.2.5-intel-19.0.5-c5avlia --with-iconv=/apps/spack/anvil/apps/libiconv/1.16-intel-19.0.5-4bnuwas --without-python]])
...
local modroot="/apps/spack/anvil/apps/libxml2/2.9.10-intel-19.0.5-et26472"
