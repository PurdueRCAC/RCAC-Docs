-- -*- lua -*---
-- hdf@4.2.15%intel@19.0.5+external-xdr+fortran~java~netcdf+pic~shared+szip arch=linux-centos8-zen2/ytzklyv
--
...
whatis([[Configure options : --enable-production --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-intel-19.0.5-v2223dl --with-jpeg=/apps/spack/anvil/apps/libjpeg-turbo/2.1.0-intel-19.0.5-k7mkb62 --disable-shared --disable-netcdf --enable-fortran --disable-java --with-szlib=/apps/spack/anvil/apps/libszip/2.1.1-intel-19.0.5-tntz24m LIBS=-ltirpc]])
...
local modroot="/apps/spack/anvil/apps/hdf/4.2.15-intel-19.0.5-ytzklyv"
