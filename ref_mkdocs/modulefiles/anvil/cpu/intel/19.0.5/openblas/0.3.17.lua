-- -*- lua -*---
-- openblas@0.3.17%intel@19.0.5~bignuma~consistent_fpcsr~ilp64+locking+pic+shared threads=openmp arch=linux-centos8-zen2/6nnbut5
--
...
local modroot="/apps/spack/anvil/apps/openblas/0.3.17-intel-19.0.5-6nnbut5"
