-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@10.2.0+doxygen+pic+shared+static arch=linux-rocky8-zen2/ml7s6bf
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-gcc-10.2.0-ml7s6bf"
