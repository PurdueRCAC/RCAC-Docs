-- -*- lua -*---
-- fftw@2.1.5%gcc@10.2.0+mpi+openmp~pfft_patches precision=double,float arch=linux-rocky8-zen2/bh4s3l5
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-gcc-10.2.0-bh4s3l5"
