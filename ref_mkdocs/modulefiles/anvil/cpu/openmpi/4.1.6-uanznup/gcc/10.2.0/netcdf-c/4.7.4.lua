-- -*- lua -*---
-- netcdf-c@4.7.4%gcc@10.2.0~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-rocky8-zen2/khqckqb
--
...
whatis([[Configure options : --enable-v2 --enable-utilities --enable-static --enable-largefile --enable-netcdf-4 --disable-fsync --enable-dynamic-loading --enable-shared --disable-dap --enable-parallel4 --disable-jna --disable-pnetcdf CC=/apps/spack/anvil/apps/openmpi/4.1.6-gcc-10.2.0-uanznup/bin/mpicc --enable-hdf4 CFLAGS=-fPIC CPPFLAGS=-I/apps/spack/anvil/apps/hdf5/1.10.7-gcc-10.2.0-jfzgmbj/include -I/apps/spack/anvil/apps/hdf/4.2.15-gcc-10.2.0-ticwyii/include LDFLAGS=-L/apps/spack/anvil/apps/hdf5/1.10.7-gcc-10.2.0-jfzgmbj/lib -L/apps/spack/anvil/apps/hdf/4.2.15-gcc-10.2.0-ticwyii/lib LIBS=-ljpeg -lsz -ltirpc]])
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-gcc-10.2.0-khqckqb"
