-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@10.2.0~burstbuffer+cxx+fortran+pic+shared arch=linux-rocky8-zen2/lwwgkcu
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-gcc-10.2.0-lwwgkcu"
