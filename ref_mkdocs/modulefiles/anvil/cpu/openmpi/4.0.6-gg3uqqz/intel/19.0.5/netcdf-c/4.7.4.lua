-- -*- lua -*---
-- netcdf-c@4.7.4%intel@19.0.5~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-centos8-zen2/qkulbu7
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-intel-19.0.5-qkulbu7"
