-- -*- lua -*---
-- netcdf-c@4.7.4%gcc@8.4.0~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-rocky8-zen/gyybspk
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-gcc-8.4.0-gyybspk"
