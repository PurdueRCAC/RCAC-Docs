-- -*- lua -*---
-- hdf5@1.10.7%gcc@8.4.0+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-rocky8-zen/3i6m3wj
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-gcc-8.4.0-3i6m3wj"
