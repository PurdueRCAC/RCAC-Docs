-- -*- lua -*---
-- fftw@3.3.8%gcc@8.4.0+mpi+openmp~pfft_patches precision=double,float arch=linux-rocky8-zen/sqexlew
--
...
local modroot="/apps/spack/anvil/apps/fftw/3.3.8-gcc-8.4.0-sqexlew"
