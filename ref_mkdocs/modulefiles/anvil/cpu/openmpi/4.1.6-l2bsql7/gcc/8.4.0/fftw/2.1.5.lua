-- -*- lua -*---
-- fftw@2.1.5%gcc@8.4.0+mpi+openmp~pfft_patches precision=double,float arch=linux-rocky8-zen/tc47nhx
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-gcc-8.4.0-tc47nhx"
