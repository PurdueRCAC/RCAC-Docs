-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@10.2.0+doxygen+pic+shared+static arch=linux-centos8-zen2/zs4sgcp
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-gcc-10.2.0-zs4sgcp"
