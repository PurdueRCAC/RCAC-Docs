-- -*- lua -*---
-- fftw@3.3.8%gcc@10.2.0+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen2/6kkkaz2
--
...
local modroot="/apps/spack/anvil/apps/fftw/3.3.8-gcc-10.2.0-6kkkaz2"
