-- -*- lua -*---
-- netcdf-c@4.7.4%gcc@10.2.0~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-centos8-zen2/tqdqmp6
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-gcc-10.2.0-tqdqmp6"
