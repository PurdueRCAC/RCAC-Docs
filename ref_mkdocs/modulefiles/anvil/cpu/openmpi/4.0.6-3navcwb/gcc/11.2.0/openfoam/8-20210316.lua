...
whatis("invoke OpenFOAM 8-20210316")
...
local cluster = "anvil"
local version = "8-20210316"
local majorv = "8"
local app = "openfoam"
local product = "OpenFOAM"
local modroot = "/apps/spack/"..cluster.."/external/"..app.."/"..product.."-"..majorv.."_2021.1025"
...
local foammpi = "openmpi-4.0.6"
local thirdp_platform=thirdp.."/platforms/"..extopts
local mpidir = "/apps/spack/anvil/apps/openmpi/4.0.6-gcc-11.2.0-3navcwb" 
