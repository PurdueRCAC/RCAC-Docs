-- -*- lua -*---
-- gromacs@2021.2%gcc@11.2.0~blas~cuda~cycle_subcounters~double+hwloc~ipo~lapack~mdrun_only+mpi~nosuffix~opencl+openmp~plumed~relaxed_double_precision+shared~sycl build_type=RelWithDebInfo arch=linux-centos8-zen3/ixlnlpl
--
...
local modroot="/apps/spack/anvil/apps/gromacs/2021.2-gcc-11.2.0-ixlnlpl"
