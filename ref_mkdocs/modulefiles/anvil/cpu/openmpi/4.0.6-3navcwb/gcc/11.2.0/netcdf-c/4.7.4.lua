-- -*- lua -*---
-- netcdf-c@4.7.4%gcc@11.2.0~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-centos8-zen3/vrjlz2r
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-gcc-11.2.0-vrjlz2r"
