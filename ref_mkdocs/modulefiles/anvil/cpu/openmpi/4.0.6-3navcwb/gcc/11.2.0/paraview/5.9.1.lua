-- -*- lua -*---
-- paraview@5.9.1%gcc@11.2.0+advanced_debug~cuda~examples+hdf5~ipo+kits+mpi+opengl2~osmesa+plugins~python+python3+qt+shared build_type=RelWithDebInfo cuda_arch=native patches=405d4511b492e9b9803c63f9b96c4d1445b4d5e65bddc02fc97da227d60614b3 arch=linux-centos8-zen3/qnb7l4e
--
...
local modroot="/apps/spack/anvil/apps/paraview/5.9.1-gcc-11.2.0-qnb7l4e"
...
prepend_path("PYTHONPATH", "/apps/spack/anvil/apps/py-mpi4py/3.0.3-gcc-11.2.0-4co725z/lib/python3.9/site-packages", ":")
