-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@11.2.0~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen3/2nqmhn3
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-gcc-11.2.0-2nqmhn3"
