-- -*- lua -*---
-- netcdf-cxx4@4.3.1%aocc@3.1.0+doxygen+pic+shared+static arch=linux-rocky8-zen3/smoqmed
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-aocc-3.1.0-smoqmed"
