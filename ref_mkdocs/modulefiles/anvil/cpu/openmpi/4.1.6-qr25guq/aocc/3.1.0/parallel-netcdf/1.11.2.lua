-- -*- lua -*---
-- parallel-netcdf@1.11.2%aocc@3.1.0~burstbuffer+cxx+fortran+pic+shared arch=linux-rocky8-zen3/o6n4uaz
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-aocc-3.1.0-o6n4uaz"
