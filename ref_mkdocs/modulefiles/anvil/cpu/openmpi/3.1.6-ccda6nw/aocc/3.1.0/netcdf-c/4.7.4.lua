-- -*- lua -*---
-- netcdf-c@4.7.4%aocc@3.1.0~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-centos8-zen3/hqu3idu
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-aocc-3.1.0-hqu3idu"
