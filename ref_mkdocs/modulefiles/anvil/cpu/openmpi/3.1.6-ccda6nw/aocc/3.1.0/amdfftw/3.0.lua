-- -*- lua -*---
-- amdfftw@3.0%aocc@3.1.0~amd-fast-planner~debug+mpi+openmp+shared~threads precision=double,float arch=linux-centos8-zen3/c6ymjeu
--
...
local modroot="/apps/spack/anvil/apps/amdfftw/3.0-aocc-3.1.0-c6ymjeu"
