-- -*- lua -*---
-- fftw@2.1.5%aocc@3.1.0+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen3/stmvcwd
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-aocc-3.1.0-stmvcwd"
