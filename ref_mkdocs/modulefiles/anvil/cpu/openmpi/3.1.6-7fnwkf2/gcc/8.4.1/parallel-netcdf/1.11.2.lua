-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.4.1~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen/w4skkfg
--
...
whatis([[Configure options : --with-mpi=/apps/spack/anvil/apps/openmpi/3.1.6-gcc-8.4.1-7fnwkf2 SEQ_CC=/apps/spack/anvil/framework/spack/lib/spack/env/gcc/gcc --enable-cxx --enable-fortran CFLAGS=-fPIC CXXFLAGS=-fPIC FCFLAGS=-fPIC FFLAGS=-fPIC --enable-relax-coord-bound --enable-shared --enable-static --disable-silent-rules]])
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-gcc-8.4.1-w4skkfg"
