-- -*- lua -*---
-- fftw@2.1.5%gcc@8.4.1+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen/24clf2p
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-gcc-8.4.1-24clf2p"
