-- -*- lua -*---
-- netcdf-c@4.7.4%intel@19.0.5~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-rocky8-zen2/s4yiaxl
--
...
whatis([[Configure options : --enable-v2 --enable-utilities --enable-static --enable-largefile --enable-netcdf-4 --disable-fsync --enable-dynamic-loading --enable-shared --disable-dap --enable-parallel4 --disable-jna --disable-pnetcdf CC=/apps/spack/anvil/apps/openmpi/4.1.6-intel-19.0.5-oukubov/bin/mpicc --enable-hdf4 CFLAGS=-fPIC CPPFLAGS=-I/apps/spack/anvil/apps/hdf5/1.10.7-intel-19.0.5-uha2d53/include -I/apps/spack/anvil/apps/hdf/4.2.15-intel-19.0.5-3huhkzw/include LDFLAGS=-L/apps/spack/anvil/apps/hdf5/1.10.7-intel-19.0.5-uha2d53/lib -L/apps/spack/anvil/apps/hdf/4.2.15-intel-19.0.5-3huhkzw/lib LIBS=-ljpeg -lsz -ltirpc]])
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-intel-19.0.5-s4yiaxl"
