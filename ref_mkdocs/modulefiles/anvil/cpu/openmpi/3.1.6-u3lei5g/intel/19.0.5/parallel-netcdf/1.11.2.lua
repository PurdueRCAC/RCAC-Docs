-- -*- lua -*---
-- parallel-netcdf@1.11.2%intel@19.0.5~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen2/vgoptpb
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-intel-19.0.5-vgoptpb"
