-- -*- lua -*---
-- hdf5@1.10.7%intel@19.0.5+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-centos8-zen2/2s2hdxf
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-intel-19.0.5-2s2hdxf"
