-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@11.2.0+doxygen+pic+shared+static arch=linux-centos8-zen3/mt23ucr
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-gcc-11.2.0-mt23ucr"
