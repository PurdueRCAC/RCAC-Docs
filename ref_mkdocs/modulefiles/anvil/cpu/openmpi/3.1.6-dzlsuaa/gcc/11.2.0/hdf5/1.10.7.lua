-- -*- lua -*---
-- hdf5@1.10.7%gcc@11.2.0+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-centos8-zen3/46jp6wm
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-gcc-11.2.0-46jp6wm"
