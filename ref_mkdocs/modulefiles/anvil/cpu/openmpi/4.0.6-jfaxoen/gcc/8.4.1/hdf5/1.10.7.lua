-- -*- lua -*---
-- hdf5@1.10.7%gcc@8.4.1+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-centos8-zen/yh67xay
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-gcc-8.4.1-yh67xay"
