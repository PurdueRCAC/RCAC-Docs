-- -*- lua -*---
-- netcdf-c@4.7.4%gcc@8.4.1~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-centos8-zen/s6vgco6
--
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-gcc-8.4.1-s6vgco6"
