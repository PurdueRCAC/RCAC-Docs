-- -*- lua -*---
-- hdf5@1.10.7%gcc@10.2.0+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-centos8-zen2/ayy6q7n
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-gcc-10.2.0-ayy6q7n"
