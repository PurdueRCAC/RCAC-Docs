...
whatis([[Name : vasp]])
whatis([[Version : 6.3.0-wannier90]])
...
This module links the VASP compiled with wannier90. ]])
...
depends_on("wannier90/3.1.0")

local modroot="/apps/spack/anvil/external/vasp/vasp.6.3.0-openmpi-4.1.6-wannier90/"
prepend_path("PATH", modroot.."/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", modroot.."/", ":")
setenv("VASP_HOME", modroot)
setenv("RCAC_VASP_ROOT", modroot)
setenv("RCAC_VASP_VERSION", "6.3.0-wannier90")
