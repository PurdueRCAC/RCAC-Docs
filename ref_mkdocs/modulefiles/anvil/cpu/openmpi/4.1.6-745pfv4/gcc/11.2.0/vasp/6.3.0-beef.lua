...
help([[ This VASP module linked with libbeef which can be used for the electronic structure calculations with the Bayesian Error Estimation Functional (BEEF). ]])
...
local modroot="/apps/spack/anvil/external/vasp/vasp.6.3.0-openmpi-4.1.6-beef"
prepend_path("PATH", modroot.."/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", modroot.."/", ":")
prepend_path("LD_LIBRARY_PATH", modroot.."/libbeef/lib/", ":")
setenv("VASP_HOME", modroot)
setenv("RCAC_VASP_ROOT", modroot)
setenv("RCAC_VASP_VERSION", "6.3.0-beef")
