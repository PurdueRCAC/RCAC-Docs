...
principles.
This compilation contains source code and scripts for finding saddle points and evaluating transition state theory (TST) rate constants with VASP.]])
...
local modroot="/apps/spack/anvil/external/vasp/vasp.5.4.4.pl2-openmpi-4.1.6-vtst/"
prepend_path("PATH", modroot.."/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", modroot.."/", ":")
setenv("VASP_HOME", modroot)
setenv("RCAC_VASP_ROOT", modroot)
setenv("RCAC_VASP_VERSION", "5.4.4.pl2-vtst")
