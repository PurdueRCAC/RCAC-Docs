-- -*- lua -*---
-- parallel-netcdf@1.11.2%intel@19.1.3~burstbuffer+cxx+fortran+pic+shared arch=linux-rocky8-zen2/amvsvcr
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-intel-19.1.3-amvsvcr"
