-- -*- lua -*---
-- hdf5@1.10.7%intel@19.1.3+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-rocky8-zen2/rvhswqi
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-intel-19.1.3-rvhswqi"
