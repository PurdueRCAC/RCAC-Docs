-- -*- lua -*---
-- fftw@2.1.5%intel@19.1.3+mpi+openmp~pfft_patches precision=double,float arch=linux-rocky8-zen2/qv3ckxd
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-intel-19.1.3-qv3ckxd"
