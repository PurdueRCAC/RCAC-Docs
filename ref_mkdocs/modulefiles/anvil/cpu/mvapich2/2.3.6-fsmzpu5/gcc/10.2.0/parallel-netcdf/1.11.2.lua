-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@10.2.0~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen2/pdo57ag
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-gcc-10.2.0-pdo57ag"
