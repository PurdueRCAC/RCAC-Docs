-- -*- lua -*---
-- fftw@2.1.5%gcc@10.2.0+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen2/klmpvvs
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-gcc-10.2.0-klmpvvs"
