-- -*- lua -*---
-- netcdf-cxx4@4.3.1%intel@19.0.5+doxygen+pic+shared+static arch=linux-centos8-zen2/gdejxbz
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-intel-19.0.5-gdejxbz"
