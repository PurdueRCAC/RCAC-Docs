-- -*- lua -*---
-- fftw@2.1.5%gcc@8.4.1+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen/oyvzsc2
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-gcc-8.4.1-oyvzsc2"
