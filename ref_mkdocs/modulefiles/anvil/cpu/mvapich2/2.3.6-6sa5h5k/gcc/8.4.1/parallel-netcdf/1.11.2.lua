-- -*- lua -*---
-- parallel-netcdf@1.11.2%gcc@8.4.1~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen/73yms24
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-gcc-8.4.1-73yms24"
