-- -*- lua -*---
-- fftw@3.3.8%gcc@8.4.1+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen/f6grgwl
--
...
local modroot="/apps/spack/anvil/apps/fftw/3.3.8-gcc-8.4.1-f6grgwl"
