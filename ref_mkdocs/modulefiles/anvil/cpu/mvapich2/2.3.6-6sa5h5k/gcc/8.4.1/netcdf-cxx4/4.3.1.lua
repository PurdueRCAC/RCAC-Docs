-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@8.4.1+doxygen+pic+shared+static arch=linux-centos8-zen/zxqczoy
--
...
local modroot="/apps/spack/anvil/apps/netcdf-cxx4/4.3.1-gcc-8.4.1-zxqczoy"
