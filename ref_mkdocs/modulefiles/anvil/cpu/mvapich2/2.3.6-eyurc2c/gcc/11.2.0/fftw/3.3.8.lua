-- -*- lua -*---
-- fftw@3.3.8%gcc@11.2.0+mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen3/pckswus
--
...
local modroot="/apps/spack/anvil/apps/fftw/3.3.8-gcc-11.2.0-pckswus"
