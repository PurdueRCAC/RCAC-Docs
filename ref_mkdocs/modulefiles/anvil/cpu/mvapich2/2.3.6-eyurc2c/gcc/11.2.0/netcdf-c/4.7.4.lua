-- -*- lua -*---
-- netcdf-c@4.7.4%gcc@11.2.0~dap~fsync+hdf4~jna+mpi~parallel-netcdf+pic+shared arch=linux-centos8-zen3/2cu555z
--
...
whatis([[Configure options : --enable-v2 --enable-utilities --enable-static --enable-largefile --enable-netcdf-4 --disable-fsync --enable-dynamic-loading --enable-shared --disable-dap --enable-parallel4 --disable-jna --disable-pnetcdf CC=/apps/spack/anvil/apps/mvapich2/2.3.6-gcc-11.2.0-eyurc2c/bin/mpicc --enable-hdf4 CFLAGS=-fPIC CPPFLAGS=-I/apps/spack/anvil/apps/hdf5/1.10.7-gcc-11.2.0-axhcpbs/include -I/apps/spack/anvil/apps/hdf/4.2.15-gcc-11.2.0-xesbqdw/include LDFLAGS=-L/apps/spack/anvil/apps/hdf5/1.10.7-gcc-11.2.0-axhcpbs/lib -L/apps/spack/anvil/apps/hdf/4.2.15-gcc-11.2.0-xesbqdw/lib LIBS=-ljpeg -lsz -ltirpc]])
...
local modroot="/apps/spack/anvil/apps/netcdf-c/4.7.4-gcc-11.2.0-2cu555z"
