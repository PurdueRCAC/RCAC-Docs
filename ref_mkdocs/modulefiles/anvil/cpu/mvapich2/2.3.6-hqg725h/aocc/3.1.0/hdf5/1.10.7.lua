-- -*- lua -*---
-- hdf5@1.10.7%aocc@3.1.0+cxx+fortran+hl~ipo~java+mpi+shared+szip+threadsafe+tools api=default build_type=RelWithDebInfo arch=linux-centos8-zen3/hrsjmop
--
...
local modroot="/apps/spack/anvil/apps/hdf5/1.10.7-aocc-3.1.0-hrsjmop"
