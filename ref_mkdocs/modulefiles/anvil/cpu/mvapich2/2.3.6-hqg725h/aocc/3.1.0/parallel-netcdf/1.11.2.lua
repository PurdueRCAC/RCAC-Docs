-- -*- lua -*---
-- parallel-netcdf@1.11.2%aocc@3.1.0~burstbuffer+cxx+fortran+pic+shared arch=linux-centos8-zen3/tw6ltfx
--
...
local modroot="/apps/spack/anvil/apps/parallel-netcdf/1.11.2-aocc-3.1.0-tw6ltfx"
