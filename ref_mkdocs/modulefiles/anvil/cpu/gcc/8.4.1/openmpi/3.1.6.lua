-- -*- lua -*---
-- openmpi@3.1.6%gcc@8.4.1~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-centos8-zen/7fnwkf2
--

whatis([[Name : openmpi]])
whatis([[Version : 3.1.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-gcc-8.4.1-dif34jo --without-lsf --with-slurm --without-sge --without-loadleveler --without-alps --without-tm --disable-memchecker --with-hwloc=/apps/spack/anvil/apps/hwloc/1.11.13-gcc-8.4.1-ejh6h3z --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/openmpi/3.1.6-7fnwkf2/gcc/8.4.1")
...
setenv("LMOD_MPI_VERSION", "3.1.6-7fnwkf2")
...
local modroot="/apps/spack/anvil/apps/openmpi/3.1.6-gcc-8.4.1-7fnwkf2"
