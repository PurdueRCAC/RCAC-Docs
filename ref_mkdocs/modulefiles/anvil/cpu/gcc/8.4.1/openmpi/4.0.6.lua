-- -*- lua -*---
-- openmpi@4.0.6%gcc@8.4.1~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-centos8-zen/jfaxoen
--

whatis([[Name : openmpi]])
whatis([[Version : 4.0.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-gcc-8.4.1-dif34jo --enable-mpi1-compatibility --without-lsf --without-tm --without-loadleveler --with-slurm --without-alps --without-sge --disable-memchecker --with-libevent=/apps/spack/anvil/apps/libevent/2.1.12-gcc-8.4.1-fupbgni --with-hwloc=/apps/spack/anvil/apps/hwloc/2.5.0-gcc-8.4.1-pepa2lo --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/openmpi/4.0.6-jfaxoen/gcc/8.4.1")
...
setenv("LMOD_MPI_VERSION", "4.0.6-jfaxoen")

depends_on("libfabric/1.12.0")
depends_on("numactl/2.0.14")
depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/openmpi/4.0.6-gcc-8.4.1-jfaxoen"
