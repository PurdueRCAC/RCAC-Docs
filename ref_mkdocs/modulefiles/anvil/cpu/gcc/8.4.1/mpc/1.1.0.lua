...
whatis([[Configure options : --with-mpfr=/apps/spack/anvil/apps/mpfr/3.1.6-gcc-8.5.0-sneisro --with-gmp=/apps/spack/anvil/apps/gmp/6.2.1-gcc-8.5.0-kwl2v3b]])
...
local modroot="/apps/spack/anvil/apps/mpc/1.1.0-gcc-8.5.0-2jjjwpi"
