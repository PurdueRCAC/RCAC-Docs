-- -*- lua -*---
-- mvapich2@2.3.6%gcc@8.4.1~alloca~cuda~debug+regcache+wrapperrpath ch3_rank_bits=32 fabrics=mrail file_systems=auto process_managers=auto threads=multiple arch=linux-centos8-zen/6sa5h5k
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/mvapich2/2.3.6-6sa5h5k/gcc/8.4.1")
...
setenv("LMOD_MPI_VERSION", "2.3.6-6sa5h5k")

depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/mvapich2/2.3.6-gcc-8.4.1-6sa5h5k"
