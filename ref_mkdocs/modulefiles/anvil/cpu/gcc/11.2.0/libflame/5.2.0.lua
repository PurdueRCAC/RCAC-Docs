-- -*- lua -*---
-- libflame@5.2.0%gcc@11.2.0~debug+lapack2flame+shared+static patches=bf75a5b56d4d63f23d01976eb2e61bb0b2816b662a7c7a3de9f03b9276b0973a,c5cae9e9afe42a6cdca1dcfdc39058a3e75d076483467c1e0fefe6bb76a4b16b threads=none arch=linux-centos8-zen3/e3tdlcn
--
...
whatis([[Configure options : LIBS=-lmkl_intel_lp64 -lmkl_gnu_thread -lmkl_core -lgomp -lpthread -lm -ldl --enable-lapack2flame --enable-static-build --enable-dynamic-build --disable-debug --enable-multithreading=no --disable-supermatrix --enable-max-arg-list-hack]])
...
local modroot="/apps/spack/anvil/apps/libflame/5.2.0-gcc-11.2.0-e3tdlcn"
