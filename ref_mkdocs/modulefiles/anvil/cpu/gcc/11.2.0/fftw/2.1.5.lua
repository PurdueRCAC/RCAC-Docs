-- -*- lua -*---
-- fftw@2.1.5%gcc@11.2.0~mpi+openmp~pfft_patches precision=double,float arch=linux-centos8-zen3/iqospdq
--
...
local modroot="/apps/spack/anvil/apps/fftw/2.1.5-gcc-11.2.0-iqospdq"
