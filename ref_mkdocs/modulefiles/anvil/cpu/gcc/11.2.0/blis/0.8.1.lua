-- -*- lua -*---
-- blis@0.8.1%gcc@11.2.0+blas+cblas+shared+static threads=openmp arch=linux-centos8-zen3/dxhnz4w
--
...
local modroot="/apps/spack/anvil/apps/blis/0.8.1-gcc-11.2.0-dxhnz4w"
