-- -*- lua -*---
-- mvapich2@2.3.6%gcc@11.2.0~alloca~cuda~debug+regcache+wrapperrpath ch3_rank_bits=32 fabrics=mrail file_systems=auto process_managers=auto threads=multiple arch=linux-centos8-zen3/eyurc2c
--
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/mvapich2/2.3.6-eyurc2c/gcc/11.2.0")
...
setenv("LMOD_MPI_VERSION", "2.3.6-eyurc2c")

depends_on("zlib/1.2.11")

local modroot="/apps/spack/anvil/apps/mvapich2/2.3.6-gcc-11.2.0-eyurc2c"
