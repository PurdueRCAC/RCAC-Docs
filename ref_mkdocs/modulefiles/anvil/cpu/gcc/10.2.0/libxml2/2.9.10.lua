-- -*- lua -*---
-- libxml2@2.9.10%gcc@10.2.0~python arch=linux-centos8-zen2/gz35e5u
--
...
whatis([[Configure options : --with-lzma=/apps/spack/anvil/apps/xz/5.2.5-gcc-10.2.0-yjslvdt --with-iconv=/apps/spack/anvil/apps/libiconv/1.16-gcc-10.2.0-t3ulphq --without-python]])
...
local modroot="/apps/spack/anvil/apps/libxml2/2.9.10-gcc-10.2.0-gz35e5u"
