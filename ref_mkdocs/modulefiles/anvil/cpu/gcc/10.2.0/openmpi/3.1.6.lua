-- -*- lua -*---
-- openmpi@3.1.6%gcc@10.2.0~atomics~cuda+cxx+cxx_exceptions+gpfs~internal-hwloc~java+legacylaunchers~lustre~memchecker+pmi~singularity~sqlite3+static~thread_multiple+vt+wrapper-rpath fabrics=auto schedulers=slurm arch=linux-centos8-zen2/njm3wq5
--

whatis([[Name : openmpi]])
whatis([[Version : 3.1.6]])
whatis([[Short description : An open source Message Passing Interface implementation.]])
whatis([[Configure options : --enable-shared --disable-silent-rules --disable-builtin-atomics --with-pmi=/usr --enable-static --with-zlib=/apps/spack/anvil/apps/zlib/1.2.11-gcc-10.2.0-uw42aiy --without-lsf --without-alps --without-loadleveler --without-sge --with-slurm --without-tm --disable-memchecker --with-hwloc=/apps/spack/anvil/apps/hwloc/1.11.13-gcc-10.2.0-kun5gtu --disable-java --disable-mpi-java --without-cuda --enable-wrapper-rpath --disable-wrapper-runpath --enable-mpi-cxx --enable-cxx-exceptions --with-wrapper-ldflags=-Wl,-rpath,/apps/spack/anvil/apps/gcc/10.2.0-gcc-8.4.1-atomsmg/lib/gcc/x86_64-pc-linux-gnu/10.2.0 -Wl,-rpath,/apps/spack/anvil/apps/gcc/10.2.0-gcc-8.4.1-atomsmg/lib64]])
...
prepend_path("MODULEPATH", "/opt/spack/cpu-20211007/openmpi/3.1.6-njm3wq5/gcc/10.2.0")
...
setenv("LMOD_MPI_VERSION", "3.1.6-njm3wq5")
...
local modroot="/apps/spack/anvil/apps/openmpi/3.1.6-gcc-10.2.0-njm3wq5"
