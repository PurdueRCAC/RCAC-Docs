-- -*- lua -*---
-- openblas@0.3.17%gcc@10.2.0~bignuma~consistent_fpcsr~ilp64+locking+pic+shared threads=openmp arch=linux-centos8-zen2/jepzwk2
--
...
local modroot="/apps/spack/anvil/apps/openblas/0.3.17-gcc-10.2.0-jepzwk2"
