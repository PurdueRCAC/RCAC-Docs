-- -*- lua -*---
-- texlive@20200406%gcc@8.4.1 scheme=full arch=linux-centos8-zen/gjynmo4
--
...
whatis([[Configure options : --bindir=/apps/spack/anvil/apps/texlive/20200406-gcc-8.4.1-gjynmo4/bin/x86_64-linux --disable-dvisvgm --disable-native-texlive-build --disable-static --enable-shared --with-banner-add= - Spack --dataroot=/apps/spack/anvil/apps/texlive/20200406-gcc-8.4.1-gjynmo4 --with-system-cairo --with-system-freetype2 --with-system-gd --with-system-gmp --with-system-graphite2 --with-system-harfbuzz --with-system-icu --with-system-libpaper --with-system-libpng --with-system-mpfr --with-system-pixman --with-system-poppler --with-system-teckit --with-system-zlib --with-system-zziplib]])
...
local modroot="/apps/spack/anvil/apps/texlive/20200406-gcc-8.4.1-gjynmo4"
...
prepend_path("XDG_DATA_DIRS", "/apps/spack/anvil/apps/pango/1.42.0-gcc-8.4.1-orptkq2/share", ":")
prepend_path("GI_TYPELIB_PATH", "/apps/spack/anvil/apps/pango/1.42.0-gcc-8.4.1-orptkq2/lib/girepository-1.0", ":")
prepend_path("XDG_DATA_DIRS", "/apps/spack/anvil/apps/shared-mime-info/1.9-gcc-8.4.1-ykdb6aj/share", ":")
prepend_path("XDG_DATA_DIRS", "/apps/spack/anvil/apps/gtkplus/3.24.26-gcc-8.4.1-cehw2yw/share", ":")
prepend_path("GI_TYPELIB_PATH", "/apps/spack/anvil/apps/gtkplus/3.24.26-gcc-8.4.1-cehw2yw/lib/girepository-1.0", ":")
