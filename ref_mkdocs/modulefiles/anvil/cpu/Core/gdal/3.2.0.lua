-- -*- lua -*---
-- gdal@3.2.0%gcc@8.4.1~armadillo~cfitsio~crypto~cryptopp+curl~expat+geos~gif~grib+hdf4+hdf5~jasper+java+jpeg~kea~libiconv~libkml+liblzma+libtool+libz~mdb+netcdf~odbc~opencl~openjpeg~pcre~perl~pg+png~poppler+proj+python~qhull~sosi~sqlite3~xerces~xml2~zstd arch=linux-centos8-zen/4xed5zq
--
...
local modroot="/apps/spack/anvil/apps/gdal/3.2.0-gcc-8.4.1-4xed5zq"
...
prepend_path("CLASSPATH", modroot.."/gdal.jar:"..modroot.."/share/java/gdal-3.2.0.jar:"..modroot.."/share/java/gdal-3.2.0-javadoc.jar:"..modroot.."/share/java/gdal-3.2.0-sources.jar", ":")
setenv("GDAL_HOME", modroot)
setenv("RCAC_GDAL_ROOT", modroot)
setenv("RCAC_GDAL_VERSION", "3.2.0")
