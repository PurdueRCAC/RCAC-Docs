-- -*- lua -*---
-- papi@6.0.0.1%gcc@8.4.1~cuda+example+infiniband+lmsensors~nvml~powercap+rapl+sde+shared~static_tools arch=linux-centos8-zen/kjutjxw
--
...
local modroot="/apps/spack/anvil/apps/papi/6.0.0.1-gcc-8.4.1-kjutjxw"
...
setenv("PAPI_LMSENSORS_ROOT", "/apps/spack/anvil/apps/lm-sensors/3-6-0-gcc-8.4.1-guezjmc")
