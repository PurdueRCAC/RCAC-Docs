-- -*- lua -*---
-- matlab@R2021b%gcc@8.4.1 key=<installation-key-here> mode=silent arch=linux-centos8-zen/qesog73
--
...
local modroot="/apps/spack/anvil/apps/matlab/R2021b-gcc-8.4.1-qesog73"
