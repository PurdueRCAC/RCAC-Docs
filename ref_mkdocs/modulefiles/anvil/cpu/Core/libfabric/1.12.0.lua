-- -*- lua -*---
-- libfabric@1.12.0%gcc@8.4.1~debug~kdreg fabrics=mlx,shm,sockets,tcp,udp,verbs arch=linux-centos8-zen/xj6lmd4
--
...
local modroot="/apps/spack/anvil/apps/libfabric/1.12.0-gcc-8.4.1-xj6lmd4"
