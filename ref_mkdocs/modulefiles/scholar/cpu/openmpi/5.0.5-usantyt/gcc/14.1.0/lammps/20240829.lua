...
depends_on("cmake/3.30.2-mljwg6k")
depends_on("fftw/3.3.10")
depends_on("openmpi/5.0.5")

prepend_path("PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/bin", ":")
prepend_path("LIBRARY_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib", ":")
prepend_path("LIBRARY_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib64", ":")
prepend_path("CPATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/include", ":")
prepend_path("MANPATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/share/man", ":")
prepend_path("PKG_CONFIG_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib64/pkgconfig", ":")
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/.", ":")
prepend_path("PYTHONPATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib/python3.11/site-packages", ":")
prepend_path("PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/bin", ":")
setenv("LAMMPS_POTENTIALS", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/share/lammps/potentials")
prepend_path("LD_LIBRARY_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef/lib64", ":")
setenv("LAMMPS_HOME", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef")
setenv("RCAC_LAMMPS_ROOT", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef")
setenv("RCAC_LAMMPS_VERSION", "/apps/spack/scholar-all-20241220/apps/lammps/20240829-gcc-14.1.0-ye2acef")
append_path("MANPATH", "", ":")
