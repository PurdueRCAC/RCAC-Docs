-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-01-02 21:59:36.287542
--
-- r-ncdf4@1.21%gcc@11.4.1 build_system=generic arch=linux-rocky9-x86_64_v3/ujzjequ
--
...
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/scholar-all-20241220/apps/r-ncdf4/1.21-gcc-11.4.1-ujzjequ/.", ":")
setenv("R_HOME", "/apps/spack/scholar-all-20241220/apps/r/4.4.1-gcc-11.4.1-nxf3b6y/rlib/R")
prepend_path("R_LIBS", "/apps/spack/scholar-all-20241220/apps/r-ncdf4/1.21-gcc-11.4.1-ujzjequ/rlib/R/library", ":")
setenv("R_NCDF4_HOME", "/apps/spack/scholar-all-20241220/apps/r-ncdf4/1.21-gcc-11.4.1-ujzjequ")
setenv("RCAC_R_NCDF4_ROOT", "/apps/spack/scholar-all-20241220/apps/r-ncdf4/1.21-gcc-11.4.1-ujzjequ")
setenv("RCAC_R_NCDF4_VERSION", "/apps/spack/scholar-all-20241220/apps/r-ncdf4/1.21-gcc-11.4.1-ujzjequ")
