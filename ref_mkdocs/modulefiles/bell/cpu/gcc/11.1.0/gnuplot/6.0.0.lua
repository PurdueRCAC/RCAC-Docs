-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-04-27 18:17:20.608900
--
-- gnuplot@6.0.0%gcc@11.1.0~X+cairo+gd+libcerf~pbm+qt+readline~wx build_system=autotools patches=ad89f23 arch=linux-rocky8-zen2/ctdybtf
--
...
prepend_path("PATH", "/apps/spack/bell-20250305/apps/gnuplot/6.0.0-gcc-11.1.0-ctdybtf/bin", ":")
prepend_path("MANPATH", "/apps/spack/bell-20250305/apps/gnuplot/6.0.0-gcc-11.1.0-ctdybtf/share/man", ":")
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/bell-20250305/apps/gnuplot/6.0.0-gcc-11.1.0-ctdybtf/.", ":")
...
setenv("GNUPLOT_HOME", "/apps/spack/bell-20250305/apps/gnuplot/6.0.0-gcc-11.1.0-ctdybtf")
setenv("RCAC_GNUPLOT_ROOT", "/apps/spack/bell-20250305/apps/gnuplot/6.0.0-gcc-11.1.0-ctdybtf")
setenv("RCAC_GNUPLOT_VERSION", "/apps/spack/bell-20250305/apps/gnuplot/6.0.0-gcc-11.1.0-ctdybtf")
append_path("MANPATH", "", ":")
