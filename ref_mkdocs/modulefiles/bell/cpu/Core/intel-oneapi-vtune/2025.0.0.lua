-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-02-21 14:35:10.776984
--
-- intel-oneapi-vtune@2025.0.0%gcc@8.5.0+envmods build_system=generic arch=linux-rocky8-zen/jf55rpj
--
...
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj/.", ":")
setenv("VTUNE_PROFILER_2025_DIR", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj/vtune/2025.0")
setenv("VTUNE_PROFILER_DIR", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj/vtune/2025.0")
prepend_path("PATH", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj/vtune/2025.0/bin64", ":")
prepend_path("PKG_CONFIG_PATH", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj/vtune/2025.0/include/pkgconfig/lib64", ":")
setenv("INTEL_ONEAPI_VTUNE_HOME", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj")
setenv("RCAC_INTEL_ONEAPI_VTUNE_ROOT", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj")
setenv("RCAC_INTEL_ONEAPI_VTUNE_VERSION", "/apps/spack/bell-20250305/apps/intel-oneapi-vtune/2025.0.0-gcc-8.5.0-jf55rpj")
