-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-02-21 14:35:07.388055
--
-- gcc@14.2.0%gcc@8.5.0~binutils+bootstrap~graphite~mold~nvptx~piclibs~profiled~strip build_system=autotools build_type=RelWithDebInfo languages='c,c++,fortran' arch=linux-rocky8-zen/qxtdh75
--
...
prepend_path("MODULEPATH", "/opt/spack/modulefiles/gcc/14.2.0")
...
prepend_path("PATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/bin", ":")
prepend_path("LIBRARY_PATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/lib", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/lib", ":")
prepend_path("LIBRARY_PATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/lib64", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/lib64", ":")
prepend_path("CPATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/include", ":")
prepend_path("MANPATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/share/man", ":")
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/.", ":")
setenv("CC", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/bin/gcc")
setenv("FC", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/bin/gfortran")
setenv("F77", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75/bin/gfortran")
setenv("GCC_HOME", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75")
setenv("RCAC_GCC_ROOT", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75")
setenv("RCAC_GCC_VERSION", "/apps/spack/bell-20250305/apps/gcc/14.2.0-gcc-8.5.0-qxtdh75")
append_path("MANPATH", "", ":")
