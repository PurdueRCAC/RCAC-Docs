-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2025-02-15 08:41:09.737800
--
-- cdo@2.3.0%oneapi@2024.2.1~curl~external-grib1+fftw3+hdf5+libxml2~magics+netcdf+openmp+proj+szip+udunits2 build_system=autotools grib2=eccodes arch=linux-rocky9-zen2/qw6db32
--
...
prepend_path("PATH", "/apps/spack/gilbreth-r9/apps/cdo/2.3.0-oneapi-2024.2.1-qw6db32/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/apps/spack/gilbreth-r9/apps/cdo/2.3.0-oneapi-2024.2.1-qw6db32/.", ":")
setenv("CDO_HOME", "/apps/spack/gilbreth-r9/apps/cdo/2.3.0-oneapi-2024.2.1-qw6db32")
setenv("RCAC_CDO_ROOT", "/apps/spack/gilbreth-r9/apps/cdo/2.3.0-oneapi-2024.2.1-qw6db32")
setenv("RCAC_CDO_VERSION", "/apps/spack/gilbreth-r9/apps/cdo/2.3.0-oneapi-2024.2.1-qw6db32")
