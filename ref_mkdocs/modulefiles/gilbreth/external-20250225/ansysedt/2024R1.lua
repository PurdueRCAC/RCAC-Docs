...
local version = "2024R1"
local relnum = "241"
local altrelnum = "24.1"
local modroot = "/apps/external/ansysedt/EM/"..version

--# 2024R1 installed Aug 1 2023
...
prepend_path("LD_LIBRARY_PATH","/apps/external/ansysedt/Mesa")
...
help([[
	...
	Manual: /apps/external/ansysedt/EM/2024R1/v241/Linux64/Help
