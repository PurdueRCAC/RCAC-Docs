...
<p style="text-align: center;">
  <img src="/assets/images/userguides/anvil/anvilgpt/chat_controls.png" alt="GenAI Studio chat controls showing the system prompt and advanced parameters" width="40%">
</p>
...
* **Public** allows any signed-in GenAI Studio user with the link to view the conversation.
