...
```text
SERIAL REGION:     Runhost:a003.gautschi.rcac.purdue.edu   Thread:0 of 1 thread    hello, world
PARALLEL REGION:   Runhost:a003.gautschi.rcac.purdue.edu   Thread:0 of 16 threads   hello, world
PARALLEL REGION:   Runhost:a003.gautschi.rcac.purdue.edu   Thread:1 of 16 threads   hello, world
   ...
```
