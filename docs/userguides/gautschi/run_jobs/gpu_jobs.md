...
The Gautschi cluster nodes contain NVIDIA GPUs that support CUDA and OpenCL. See the [detailed hardware overview](../overview.md#gautschi-specifications) for the specifics on the GPUs in Gautschi.
...
See the [detailed hardware overview](../overview.md#gautschi-specifications) and the output of the `sfeatures` command for specifics on the GPUs in Gautschi.
