...
* **Step 0: Set up installation preferences.**  
  Follow the [steps for setting up](/knowledge/${resource.hostname}/run/examples/apps/r/rprofile) your `~/.Rprofile` preferences. This step needs to be done only once. If you have created a `~/.Rprofile` file previously on Gilbreth, ignore this step.
