...
RCAC recommends that you use dynamic linking of libguide. If so, define LD\_LIBRARY\_PATH such that you are using the correct version of libguide at run time. If you use static linking of libguide, then:
