...
{::if resource.name != Weber and resource.name !=Gautschi}
...
Neither pip nor ml-toolkit are available on Gilbreth, although they are available on the other community clusters.
