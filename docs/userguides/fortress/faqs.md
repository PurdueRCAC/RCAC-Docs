...
Research groups are assigned a group data storage space within Fortress with each Data Depot group space. Faculty should [request a Data Depot trial](/storage/depot) to create a shared Fortress space for their research group.
...
Please keep in mind that such spaces are, by design, accessible by others and should not be used to store private information such as grades, login credentials, or personal data. [Contact us](/help) to create a group space for your group.

### Can I download HSI or HTAR binaries for my OS platform?

Yes, visit the [Downloads](/downloads/archive#hsi) page to download HSI or HTAR packages for your operating system.
...
Your subscription in the Fortress mailing list is tied to your account on Fortress. If you are no longer using your account on Fortress, your account can be deleted from the [My Accounts](/account/myinfo) page. Hover over the resource you wish to remove yourself from and click the red 'X' button. Your account and mailing list subscription will be removed overnight. Be sure to make a copy of any data you wish to keep first.
