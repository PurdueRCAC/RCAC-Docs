...
<p style="text-align: center;">
  <img src="/assets/images/services/genai/output_actions.png" alt="AnvilGPT response action controls" width="30%">
</p>
...
<p style="text-align: center;">
  <img src="/assets/images/services/genai/chat-controls.png" alt="AnvilGPT chat controls showing the system prompt and advanced parameters" width="40%">
</p>
...
<p style="text-align: center;">
  <img src="/assets/images/services/genai/chat-share-dialog.png" alt="AnvilGPT chat sharing dialog" width="60%">
</p>
...
```text
https://anvilgpt.rcac.purdue.edu/s/<share-id>
```
