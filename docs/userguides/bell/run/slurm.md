...
* [Create job submission script](/knowledge/${resource.hostname}/run/slurm/script)
* [Submit job script](/knowledge/${resource.hostname}/run/slurm/submit)
* [Monitor job status](/knowledge/${resource.hostname}/run/slurm/status)
* [Check output](/knowledge/${resource.hostname}/run/slurm/output)

Follow the links below for information on these steps, and other basic information about jobs. A number of [example SLURM jobs](/knowledge/${resource.hostname}/run/examples/slurm) are also available.