...
* Please note that due to firewall rules, the Tensorboard URL may only be accessible from ${resource.name} nodes. If you cannot access the URL directly, you can use Firefox browser in {::if resource.desktop == true}[Thinlinc](https://desktop.${resource.hostname}.rcac.purdue.edu){::else}Thinlinc{::/}.
