...
* Only the provided Windows image is to be launched on ${resource.name}.
...
The Windows 2016 Base server image available on ${resource.name} has the following software packages preloaded:
