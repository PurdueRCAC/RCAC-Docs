...
* For your convenience, a sample [~/.Rprofile example file](/files/knowledge/run/examples/apps/r/Rprofile_example) is provided that can be downloaded to your cluster account and renamed into `~/.Rprofile` (or appended to one) to customize your installation preferences. [Detailed instructions](/knowledge/${resource.hostname}/run/examples/apps/r/rprofile).

### Installing Packages

* **Step 0: Set up installation preferences.**  
  Follow the [steps for setting up](/knowledge/${resource.hostname}/run/examples/apps/r/rprofile) your `~/.Rprofile` preferences. This step needs to be done only once. If you have created a `~/.Rprofile` file previously on ${resource.name}, ignore this step.
...
* **Step 3: Install the package.**  
  ...
  Installing package into ‘/home/${user.username}/R/x86_64-pc-linux-gnu-library/4.4.1’
...
Installing package into ‘/home/${user.username}/R/${resource.hostname}/4.4.1’
(as ‘lib’ is unspecified)
 ...
