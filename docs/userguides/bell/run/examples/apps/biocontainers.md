...
Brief Singularity guide and examples are available at the [${resource.name} Singularity user guide](/knowledge/${resource.dir}/run/examples/apps/singularity) page. Detailed Singularity user guide is available at: [sylabs.io/guides/3.8/user-guide](https://sylabs.io/guides/3.8/user-guide/)
...
On ${resource.name}, type the command below to see the lists of biocontainers we deployed.
...
![RCAC Biocontainers one ReadTheDocs](/files/knowledge/biocontainers/biocontainer_doc.png)