...
Note: to access ${resource.name} through SMB file sharing, you must be on a Purdue campus network or connected through [VPN](http://www.itap.purdue.edu/connections/vpn/).
...
* In the folder location, enter the following information and click Finish:
  ...
  + {::else}
  + To access your ${resource.name} home directory, enter `\\home.${resource.hostname}.rcac.purdue.edu\${resource.hostname}-home`.
  + To access your scratch space on ${resource.name}, enter `\\scratch.${resource.hostname}.rcac.purdue.edu\${resource.hostname}-scratch`. Once mapped, you will be able to navigate to your scratch directory.
  + {::/}
...
* In the Server Address enter the following information and click Connect:
  ...
  + {::else}
  + To access your ${resource.name} home directory, enter `smb://home.${resource.hostname}.rcac.purdue.edu/${resource.hostname}-home`.
  + To access your scratch space on ${resource.name}, enter `smb://scratch.${resource.hostname}.rcac.purdue.edu/${resource.hostname}-scratch`. Once mapped, you will be able to navigate to your scratch directory.
  + {::/}
