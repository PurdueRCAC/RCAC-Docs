...
First, check your firewall settings, and ensure that there are no firewall rules interfering with connecting to Fortress. For firewall configuration, please see "[Do I need to do anything to my firewall to access Fortress?](/knowledge/${resource.dir}/faq/about/firewall)" **If firewalls are not responsible:**
