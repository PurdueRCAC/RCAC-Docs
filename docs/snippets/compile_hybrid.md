...
- [hybrid_hello.f](/assets/scripts/userguides/compile/src/hybrid_hello.f)
- [hybrid_hello.f90](/assets/scripts/userguides/compile/src/hybrid_hello.f90)
- [hybrid_hello.f95](/assets/scripts/userguides/compile/src/hybrid_hello.f95)
- [hybrid_hello.c](/assets/scripts/userguides/compile/src/hybrid_hello.c)
- [hybrid_hello.cpp](/assets/scripts/userguides/compile/src/hybrid_hello.cpp)

This example illustrates a hybrid program with loop-level (data) parallelism of OpenMP:

- [hybrid_loop.c](/assets/scripts/userguides/compile/src/hybrid_loop.c)
