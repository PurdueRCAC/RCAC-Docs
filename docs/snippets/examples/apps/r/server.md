...
<p style="text-align: center;">
  <img src="/assets/images/userguides/bell/run-examples-apps-r-Sessions.png" alt="Sessions drop down menu" width="60%">
</p>
...
<p style="text-align: center;">
  <img src="/assets/images/userguides/bell/run-examples-apps-r-package_GUI.png" alt="Package selection from GUI" width="80%">
</p>
