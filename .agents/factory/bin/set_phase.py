...
The ``docs-draft`` and ``docs-review`` skills call this to advance state rather
than hand-editing YAML (surgical in-place YAML edits corrupt indentation). It
parses the frontmatter, applies the requested mutations, re-serializes the
frontmatter canonically, and writes the file back with the body preserved
verbatim.
