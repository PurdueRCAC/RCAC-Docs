-- -*- lua -*---
-- gcc@14.4.0%gcc@8.5.0~binutils+bootstrap~graphite~nvptx~piclibs~profiled~strip build_system=autotools build_type=RelWithDebInfo languages=c,c++,fortran arch=linux-rocky8-zen/gyql3pb
--

whatis([[Name : gcc]])
whatis([[Version : 14.4.0]])
...
prepend_path("MODULEPATH", "/apps/spack/negishi/modules/lmod/linux-rocky8-x86_64/gcc/14.4.0")
...
local modroot="/apps/spack/negishi/apps/gcc/14.4.0-gcc-8.5.0-gyql3pb"
...
setenv("RCAC_GCC_VERSION", "14.4.0")
