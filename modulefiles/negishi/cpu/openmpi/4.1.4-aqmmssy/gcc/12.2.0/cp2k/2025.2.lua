-- -*- lua -*---
-- cp2k@2025.2%gcc@12.2.0+cosma~cuda+elpa+libint~libvori+libxc+mpi+openmp~pexsi+plumed~sirius~spglib build_system=makefile lmax=5 smm=libxsmm arch=linux-rocky8-zen3/xnvj2mc
--
...
local modroot="/apps/spack/negishi/apps/cp2k/2025.2-gcc-12.2.0-xnvj2mc"
...
setenv("RCAC_CP2K_VERSION", "2025.2")
