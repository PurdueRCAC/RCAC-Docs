...
local modroot="/apps/spack/anvil/external/vasp/vasp.6.6.0-intel-2024.1"
prepend_path("PATH", modroot.."/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", modroot.."/", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/anvil/external/apps/intel/oneapi/2024.1/mkl/2024.1/lib/")
setenv("VASP_HOME", modroot)
setenv("RCAC_VASP_ROOT", modroot)
setenv("RCAC_VASP_VERSION", "6.6.0")
