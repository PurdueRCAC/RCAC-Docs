-- -*- lua -*---
-- gromacs@2024.3%gcc@13.3.0~cp2k+cuda~cufftmp~cycle_subcounters~double+gmxapi+hwloc~intel_provided_gcc~ipo~mdrun_only+mpi+nblib~nosuffix~nvshmem~opencl+openmp~relaxed_double_precision+shared~sycl build_system=cmake build_type=Release cuda_arch=none generator=make openmp_max_threads=none arch=linux-rocky8-zen3/fp25emj
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/gromacs/2024.3-gcc-13.3.0-fp25emj"
