-- -*- lua -*---
-- py-mpi4py@3.1.6%gcc@13.3.0 build_system=python_pip arch=linux-rocky8-zen3/5oxvp3h
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/py-mpi4py/3.1.6-gcc-13.3.0-5oxvp3h"
