...
depends_on("cmake/3.30.2-5znp6js")
depends_on("cuda/12.6.1-qmri43f")
depends_on("fftw/3.3.10")
depends_on("openmpi/5.0.5-cu12.6.1")

local modroot="/apps/spack/anvilgpu-2025/apps/lammps/20240829-gcc-13.3.0-nldsgrk"
