-- -*- lua -*---
-- parallel-netcdf@1.12.3%gcc@13.3.0+burstbuffer+cxx+fortran+pic+shared build_system=autotools arch=linux-rocky8-zen3/qza6dzc
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/parallel-netcdf/1.12.3-gcc-13.3.0-qza6dzc"
