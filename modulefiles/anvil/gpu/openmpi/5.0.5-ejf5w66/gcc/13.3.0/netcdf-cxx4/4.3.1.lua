-- -*- lua -*---
-- netcdf-cxx4@4.3.1%gcc@13.3.0~doc~ipo+pic+shared~tests build_system=cmake build_type=Release generator=make arch=linux-rocky8-zen3/u4vpddm
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/netcdf-cxx4/4.3.1-gcc-13.3.0-u4vpddm"
