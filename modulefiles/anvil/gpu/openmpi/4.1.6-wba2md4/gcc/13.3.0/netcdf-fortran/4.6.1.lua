-- -*- lua -*---
-- netcdf-fortran@4.6.1%gcc@13.3.0~doc+pic+shared build_system=autotools arch=linux-rocky8-zen3/cgubb3i
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/netcdf-fortran/4.6.1-gcc-13.3.0-cgubb3i"
