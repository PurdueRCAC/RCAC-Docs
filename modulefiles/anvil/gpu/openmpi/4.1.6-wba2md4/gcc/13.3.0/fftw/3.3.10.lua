-- -*- lua -*---
-- fftw@3.3.10%gcc@13.3.0+mpi+openmp~pfft_patches+shared build_system=autotools precision=double,float arch=linux-rocky8-zen3/k7qe3zc
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/fftw/3.3.10-gcc-13.3.0-k7qe3zc"
