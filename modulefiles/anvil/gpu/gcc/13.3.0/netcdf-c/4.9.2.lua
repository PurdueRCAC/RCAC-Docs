-- -*- lua -*---
-- netcdf-c@4.9.2%gcc@13.3.0+blosc+byterange+dap~fsync+hdf4~ipo~jna~logging~mpi~nczarr_zip+optimize~parallel-netcdf+pic+shared+szip+zstd build_system=cmake build_type=Release generator=make patches=0161eb8,3b09181 arch=linux-rocky8-zen3/ganr4e3
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/netcdf-c/4.9.2-gcc-13.3.0-ganr4e3"
