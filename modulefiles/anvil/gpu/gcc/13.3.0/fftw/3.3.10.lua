-- -*- lua -*---
-- fftw@3.3.10%gcc@13.3.0~mpi+openmp~pfft_patches+shared build_system=autotools precision=double,float arch=linux-rocky8-zen3/46ylslc
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/fftw/3.3.10-gcc-13.3.0-46ylslc"
