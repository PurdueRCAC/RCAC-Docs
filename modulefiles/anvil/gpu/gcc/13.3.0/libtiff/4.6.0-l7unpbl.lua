-- -*- lua -*---
-- libtiff@4.6.0%gcc@13.3.0+ccitt~ipo~jbig+jpeg~jpeg12~lerc~libdeflate+logluv~lzma+lzw+next~old-jpeg+packbits~pic~pixarlog+shared+thunder~webp+zlib~zstd build_system=cmake build_type=Release generator=make arch=linux-rocky8-zen3/l7unpbl
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/libtiff/4.6.0-gcc-13.3.0-l7unpbl"
