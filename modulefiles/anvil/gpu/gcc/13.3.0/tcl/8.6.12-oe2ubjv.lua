-- -*- lua -*---
-- tcl@8.6.12%gcc@13.3.0 build_system=autotools arch=linux-rocky8-zen3/oe2ubjv
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/tcl/8.6.12-gcc-13.3.0-oe2ubjv"
...
setenv("RCAC_TCL_VERSION", modroot)
