-- -*- lua -*---
-- libxml2@2.10.3%gcc@13.3.0+pic~python+shared build_system=autotools arch=linux-rocky8-zen3/af3sqt3
--
...
depends_on("libiconv/1.17-cdibrpv")
depends_on("zlib/1.3.1-ummgjdr")

local modroot="/apps/spack/anvilgpu-2025/apps/libxml2/2.10.3-gcc-13.3.0-af3sqt3"
