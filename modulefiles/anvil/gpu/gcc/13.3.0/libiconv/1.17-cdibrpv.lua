-- -*- lua -*---
-- libiconv@1.17%gcc@13.3.0 build_system=autotools libs=shared,static arch=linux-rocky8-zen3/cdibrpv
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/libiconv/1.17-gcc-13.3.0-cdibrpv"
