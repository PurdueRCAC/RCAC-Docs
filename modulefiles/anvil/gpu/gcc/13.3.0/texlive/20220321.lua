-- -*- lua -*---
-- texlive@20220321%gcc@13.3.0 build_system=autotools arch=linux-rocky8-zen3/bboi4my
--
...
whatis([[Configure options : --bindir=/apps/spack/anvilgpu-2025/apps/texlive/20220321-gcc-13.3.0-bboi4my/bin/x86_64-linux --disable-dvisvgm --disable-native-texlive-build --disable-static --enable-shared --with-banner-add= - Spack --dataroot=/apps/spack/anvilgpu-2025/apps/texlive/20220321-gcc-13.3.0-bboi4my --with-system-cairo --with-system-freetype2 --with-system-gd --with-system-gmp --with-system-graphite2 --with-system-harfbuzz --with-system-icu --with-system-libpaper --with-system-libpng --with-system-mpfr --with-system-pixman --with-system-poppler --with-system-teckit --with-system-zlib --with-system-zziplib]])
...
depends_on("mpfr/4.2.1-avf5i2w")
depends_on("zlib/1.3.1-ummgjdr")

local modroot="/apps/spack/anvilgpu-2025/apps/texlive/20220321-gcc-13.3.0-bboi4my"
