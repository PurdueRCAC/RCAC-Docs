-- -*- lua -*---
-- mvapich2@2.3.7-1%gcc@13.3.0~alloca+cuda~debug~hwloc_graphics~hwlocv2+regcache+wrapperrpath build_system=autotools ch3_rank_bits=32 fabrics=mrail file_systems=auto patches=d98d8e7 process_managers=auto threads=multiple arch=linux-rocky8-zen3/xlyhmqf
--
...
prepend_path("MODULEPATH", "/apps/spack/anvilgpu-2025/modules/lmod/linux-rocky8-x86_64/mvapich2/2.3.7-1-xlyhmqf/gcc/13.3.0")
...
setenv("LMOD_MPI_VERSION", "2.3.7-1-xlyhmqf")

depends_on("cuda/12.6.1-qmri43f")
depends_on("libxml2/2.10.3-af3sqt3")
depends_on("zlib/1.3.1-ummgjdr")

local modroot="/apps/spack/anvilgpu-2025/apps/mvapich2/2.3.7-1-gcc-13.3.0-xlyhmqf"
