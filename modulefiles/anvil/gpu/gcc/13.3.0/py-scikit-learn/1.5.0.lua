-- -*- lua -*---
-- py-scikit-learn@1.5.0%gcc@13.3.0 build_system=python_pip arch=linux-rocky8-zen3/tmiv6j4
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/py-scikit-learn/1.5.0-gcc-13.3.0-tmiv6j4"
