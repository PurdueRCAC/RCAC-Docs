-- -*- lua -*---
-- libflame@5.2.0%gcc@13.3.0~debug+lapack2flame+shared+static build_system=autotools patches=bf75a5b,c5cae9e threads=none arch=linux-rocky8-zen3/o2qq7e7
--
...
whatis([[Configure options : LIBS=-L/apps/spack/anvilgpu-2025/apps/openblas/0.3.27-gcc-13.3.0-ippvsqv/lib -lopenblas --enable-lapack2flame --enable-static-build --enable-dynamic-build --disable-debug --enable-multithreading=no --disable-supermatrix --enable-max-arg-list-hack]])
...
local modroot="/apps/spack/anvilgpu-2025/apps/libflame/5.2.0-gcc-13.3.0-o2qq7e7"
