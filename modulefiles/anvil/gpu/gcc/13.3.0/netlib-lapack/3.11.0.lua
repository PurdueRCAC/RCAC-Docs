-- -*- lua -*---
-- netlib-lapack@3.11.0%gcc@13.3.0~external-blas~ipo+lapacke+pic+shared~xblas build_system=cmake build_type=Release generator=make arch=linux-rocky8-zen3/p3sqzuk
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/netlib-lapack/3.11.0-gcc-13.3.0-p3sqzuk"
