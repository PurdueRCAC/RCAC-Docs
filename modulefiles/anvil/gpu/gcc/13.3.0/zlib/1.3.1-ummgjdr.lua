-- -*- lua -*---
-- zlib@1.3.1%gcc@13.3.0+optimize+pic+shared build_system=makefile arch=linux-rocky8-zen3/ummgjdr
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/zlib/1.3.1-gcc-13.3.0-ummgjdr"
...
setenv("RCAC_ZLIB_VERSION", modroot)
