-- -*- lua -*---
-- libiconv@1.17%gcc@8.5.0 build_system=autotools libs=shared,static arch=linux-rocky8-zen/haakotd
--
...
local modroot="/apps/spack/anvilgpu-2025/apps/libiconv/1.17-gcc-8.5.0-haakotd"
