-- -*- lua -*---
-- mpfr@4.2.1%gcc@8.5.0 build_system=autotools libs=shared,static arch=linux-rocky8-zen/7ymsytp
--
...
whatis([[Configure options : --with-gmp=/apps/spack/anvilgpu-2025/apps/gmp/6.3.0-gcc-8.5.0-o4hyb7k --enable-shared --enable-static --with-pic]])
...
local modroot="/apps/spack/anvilgpu-2025/apps/mpfr/4.2.1-gcc-8.5.0-7ymsytp"
